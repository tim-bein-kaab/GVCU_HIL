...
int32_T Simscape_DiL_Gemera_24b_a41ef8b8_4_ds_mcon_p(const NeDynamicSystem *LC,
  const NeDynamicSystemInput *t1, NeDsMethodOutput *out)
{
  static int32_T _cg_const_2[22] = { 1, 2, 3, 4, 2, 3, 4, 2, 3, 4, 0, 6, 7, 8, 9,
    7, 8, 9, 7, 8, 9, 5 };

  static int32_T _cg_const_1[11] = { 0, 1, 4, 7, 10, 11, 12, 15, 18, 21, 22 };

  (void)t1;
  (void)LC;
  out->mMCON_P.mNumCol = 10ULL;
  out->mMCON_P.mNumRow = 10ULL;
