...
int32_T Simscape_DiL_Gemera_24b_a41ef8b8_2_ds_tdxf_p(const NeDynamicSystem *LC,
  const NeDynamicSystemInput *t1, NeDsMethodOutput *out)
{
  static int32_T _cg_const_2[32] = { 0, 1, 3, 6, 7, 8, 9, 8, 10, 3, 12, 13, 4,
    10, 5, 9, 8, 12, 6, 8, 9, 7, 8, 10, 11, 14, 11, 12, 2, 12, 13, 14 };

  static int32_T _cg_const_1[16] = { 0, 5, 7, 9, 12, 13, 14, 15, 16, 18, 21, 24,
    26, 28, 30, 32 };

  (void)t1;
  (void)LC;
  out->mTDXF_P.mNumCol = 15ULL;
  out->mTDXF_P.mNumRow = 15ULL;
