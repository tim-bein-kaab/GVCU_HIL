...
int32_T Simscape_DiL_Gemera_24b_a41ef8b8_4_ds_dxicr_p(const NeDynamicSystem *LC,
  const NeDynamicSystemInput *t1, NeDsMethodOutput *out)
{
  static int32_T _cg_const_2[20] = { 0, 1, 2, 3, 1, 2, 3, 1, 2, 3, 4, 5, 6, 7, 5,
    6, 7, 5, 6, 7 };
  ...
  (void)t1;
  (void)LC;
  out->mDXICR_P.mNumCol = 10ULL;
  out->mDXICR_P.mNumRow = 8ULL;
