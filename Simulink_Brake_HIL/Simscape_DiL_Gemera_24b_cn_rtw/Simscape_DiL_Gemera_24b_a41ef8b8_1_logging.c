...
PmfMessageId Simscape_DiL_Gemera_24b_a41ef8b8_1_recordLog(const
  ...
  const double *inputDdot, double *logVector, NeuDiagnosticManager *neDiagMgr)
{
  ...
  bb[0] = sm_core_compiler_computeProximityInfoPlaneTire(
    ...
    (xx + 449), (pm_math_Transform3 *)(xx + 464), xx[179], 1, (pm_math_Vector3 *)
    (xx + 350), (pm_math_Vector3 *)(xx + 650));
  xx[464] = - xx[460];
  ...
  bb[0] = sm_core_compiler_computeProximityInfoPlaneTire(
    Simscape_DiL_Gemera_24b_a41ef8b8_1_geometry_0(NULL), (pm_math_Transform3 *)
    (xx + 449), (pm_math_Transform3 *)(xx + 666), xx[112], 1, (pm_math_Vector3 *)
    (xx + 350), (pm_math_Vector3 *)(xx + 659));
  xx[666] = - xx[653];
  ...
  bb[0] = sm_core_compiler_computeProximityInfoPlaneTire(
    Simscape_DiL_Gemera_24b_a41ef8b8_1_geometry_0(NULL), (pm_math_Transform3 *)
    (xx + 449), (pm_math_Transform3 *)(xx + 477), xx[147], 1, (pm_math_Vector3 *)
    (xx + 484), (pm_math_Vector3 *)(xx + 487));
  xx[477] = - xx[159];
  ...
  bb[0] = sm_core_compiler_computeProximityInfoPlaneTire(
    Simscape_DiL_Gemera_24b_a41ef8b8_1_geometry_0(NULL), (pm_math_Transform3 *)
    (xx + 449), (pm_math_Transform3 *)(xx + 214), xx[199], 1, (pm_math_Vector3 *)
    (xx + 221), (pm_math_Vector3 *)(xx + 260));
  xx[214] = - xx[210];
