...
#include "nesl_rtw.h"
#include "Simscape_DiL_Gemera_24b_a41ef8b8_2.h"
#include "Simscape_DiL_Gemera_24b_a41ef8b8_2_gateway.h"

void Simscape_DiL_Gemera_24b_a41ef8b8_2_gateway(void)
{
  ...
  Simscape_DiL_Gemera_24b_a41ef8b8_2_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group(
    "Simscape_DiL_Gemera_24b/config/Solver Configuration_2",
    1,
    &dae,
    &solverparams,
    &modelparams,
