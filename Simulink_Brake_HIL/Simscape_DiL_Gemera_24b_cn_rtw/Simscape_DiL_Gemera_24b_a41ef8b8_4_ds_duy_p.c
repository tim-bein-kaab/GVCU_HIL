...
int32_T Simscape_DiL_Gemera_24b_a41ef8b8_4_ds_duy_p(const NeDynamicSystem *LC,
  const NeDynamicSystemInput *t1, NeDsMethodOutput *out)
{
  static int32_T _cg_const_2[16] = { 0, 1, 4, 15, 0, 1, 4, 15, 2, 4, 5, 6, 13,
    15, 16, 17 };

  static int32_T _cg_const_1[11] = { 0, 4, 8, 8, 8, 8, 12, 12, 12, 12, 16 };

  (void)t1;
  (void)LC;
  out->mDUY_P.mNumCol = 10ULL;
  out->mDUY_P.mNumRow = 24ULL;
