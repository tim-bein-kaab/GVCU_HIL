...
const NeZCData *Simscape_DiL_Gemera_24b_a41ef8b8_1_ZCData = NULL;
PmfMessageId Simscape_DiL_Gemera_24b_a41ef8b8_1_computeAsmModeVector(const
  double *input, const double *inputDot, const double *inputDdot, int
  *modeVector, NeuDiagnosticManager *neDiagMgr)
{
  (void) input;
  (void) inputDot;
  (void) inputDdot;
...
PmfMessageId Simscape_DiL_Gemera_24b_a41ef8b8_1_computeSimModeVector(const
  double *input, const double *inputDot, const double *inputDdot, int
  *modeVector, NeuDiagnosticManager *neDiagMgr)
{
  (void) input;
...
PmfMessageId Simscape_DiL_Gemera_24b_a41ef8b8_1_computeZeroCrossings(const
