 ...
 */
/* GVCU_HIL_simscape_a37faff9_4_ds.c - body for module GVCU_HIL_simscape_a37faff9_4_ds */

#include "ne_ds.h"
#include "GVCU_HIL_simscape_a37faff9_4_ds_log.h"
#include "GVCU_HIL_simscape_a37faff9_4_ds_y.h"
#include "GVCU_HIL_simscape_a37faff9_4_ds_obs_act.h"
#include "GVCU_HIL_simscape_a37faff9_4_ds_obs_il.h"
#include "GVCU_HIL_simscape_a37faff9_4_ds_duy_p.h"
#include "GVCU_HIL_simscape_a37faff9_4_ds_obs_all.h"
#include "GVCU_HIL_simscape_a37faff9_4_ds_duy.h"
#include "GVCU_HIL_simscape_a37faff9_4_ds_mduy_p.h"
#include "GVCU_HIL_simscape_a37faff9_4_ds_tduy_p.h"
#include "GVCU_HIL_simscape_a37faff9_4_ds_mode.h"
#include "GVCU_HIL_simscape_a37faff9_4_ds_zc.h"
...
static NeObservableData s_observable_data[115] = { {
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/PS-Simulink\nConverter1",
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/External Force\nand Torque1",
    { 1, "1x1" }, "kg*m/s^2", 1.0, "N", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE,
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/PS Lookup Table (2D)1",
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/PS Lookup Table (2D)4",
    { 1, "1x1" }, "m", 1.0, "m", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "x1", }, {
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/PS Saturation", { 1,
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/PS Saturation1", { 1,
      "1x1" }, "m", 1.0, "m", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I", }, {
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/PS Subtract", { 1,
      "1x1" }, "m", 1.0, "m", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/PS Subtract1", { 1,
      "1x1" }, "m", 1.0, "m", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I1", }, {
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/Transform\nSensor1",
      { 1, "1x1" }, "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_FIXED,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE,
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/drag force/PS Constant",
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/drag force/PS Constant1",
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/drag force/PS Constant2",
    { 1, "1x1" }, "m^2", 1.0, "cm^2", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE,
    TRUE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "O", }, {
    "vehicle.multibody.chassis.Subsystem.drag_force.PS_Gain.I",
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/drag force/PS Gain",
      { 1, "1x1" }, "kg*m/s^2", 1.0, "N", NE_NOMINAL_SOURCE_MODEL,
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/drag force/PS Lookup Table (2D)",
    { 1, "1x1" }, "m", 1.0, "m", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "x1", }, {
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/drag force/PS Product",
    { 1, "1x1" }, "kg*m/s^2", 1.0, "N", NE_NOMINAL_SOURCE_MODEL,
  ...
  { "vehicle.multibody.chassis.Subsystem.drag_force.PS_Product.I2",
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/drag force/PS Product1",
  ...
  { "vehicle.multibody.chassis.Subsystem.drag_force.PS_Product1.I2",
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/drag force/PS Product2",
  ...
  { "vehicle.multibody.chassis.Subsystem.drag_force.PS_Product2.I2",
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/drag force/PS Product3",
    { 1, "1x1" }, "m^2/s^2", 1.0, "kJ/kg", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I1", },
  { "vehicle.multibody.chassis.Subsystem.drag_force.PS_Product3.I2",
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/drag force/PS Product4",
  ...
  { "vehicle.multibody.chassis.Subsystem.drag_force.PS_Product4.O",
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/drag force/PS Product5",
    { 1, "1x1" }, "m^2/s^2", 1.0, "kJ/kg", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I1", },
  { "vehicle.multibody.chassis.Subsystem.drag_force.PS_Product5.I2",
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/drag force/PS Sign",
      { 1, "1x1" }, "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_DERIVED,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I", },
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/drag force", { 1,
      "1x1" }, "m", 1.0, "m", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    ...
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "fx", }, {
    ...
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "vx", }, {
    "vehicle.multibody.chassis.Subsystem.front_downforce.PS_Constant.O",
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/front downforce/PS Constant",
    { 1, "1x1" }, "1", 1.0, "1", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    TRUE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "O", }, {
    "vehicle.multibody.chassis.Subsystem.front_downforce.PS_Constant1.O",
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/front downforce/PS Constant1",
    { 1, "1x1" }, "kg/m^3", 1.0, "kg/m^3", NE_NOMINAL_SOURCE_DERIVED,
    NE_INIT_MODE_NONE, TRUE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "O", }, {
    "vehicle.multibody.chassis.Subsystem.front_downforce.PS_Constant2.O",
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/front downforce/PS Constant2",
    { 1, "1x1" }, "m^2", 1.0, "cm^2", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE,
    TRUE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "O", }, {
    "vehicle.multibody.chassis.Subsystem.front_downforce.PS_Lookup_Table_2D.I1",
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/front downforce/PS Lookup Table (2D)",
    { 1, "1x1" }, "m", 1.0, "m", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "x1", }, {
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/front downforce/PS Product",
    { 1, "1x1" }, "kg*m/s^2", 1.0, "N", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I1", },
  { "vehicle.multibody.chassis.Subsystem.front_downforce.PS_Product.I2",
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/front downforce/PS Product1",
    { 1, "1x1" }, "kg/(m*s^2)", 1.0, "bar", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I1", },
  { "vehicle.multibody.chassis.Subsystem.front_downforce.PS_Product1.I2",
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/front downforce/PS Product2",
    { 1, "1x1" }, "m^2/s^2", 1.0, "kJ/kg", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I1", },
  { "vehicle.multibody.chassis.Subsystem.front_downforce.PS_Product2.I2",
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/front downforce/PS Product3",
    { 1, "1x1" }, "m^2/s^2", 1.0, "kJ/kg", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I1", },
  { "vehicle.multibody.chassis.Subsystem.front_downforce.PS_Product3.I2",
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/front downforce/PS Product4",
    { 1, "1x1" }, "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_DERIVED,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I1", },
  ...
  { "vehicle.multibody.chassis.Subsystem.front_downforce.PS_Product4.O",
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/front downforce", { 1,
      "1x1" }, "m", 1.0, "m", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "frh", }, {
    "vehicle.multibody.chassis.Subsystem.front_downforce.fz",
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/front downforce", { 1,
      "1x1" }, "kg*m/s^2", 1.0, "N", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "fz", }, {
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/rear downforce/PS Constant",
    { 1, "1x1" }, "1", 1.0, "1", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    TRUE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "O", }, {
    "vehicle.multibody.chassis.Subsystem.rear_downforce.PS_Constant1.O",
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/rear downforce/PS Constant1",
    { 1, "1x1" }, "kg/m^3", 1.0, "kg/m^3", NE_NOMINAL_SOURCE_DERIVED,
    NE_INIT_MODE_NONE, TRUE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "O", }, {
    "vehicle.multibody.chassis.Subsystem.rear_downforce.PS_Constant2.O",
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/rear downforce/PS Constant2",
    { 1, "1x1" }, "m^2", 1.0, "cm^2", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE,
    TRUE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "O", }, {
    "vehicle.multibody.chassis.Subsystem.rear_downforce.PS_Lookup_Table_2D.I1",
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/rear downforce/PS Lookup Table (2D)",
    { 1, "1x1" }, "m", 1.0, "m", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "x1", }, {
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/rear downforce/PS Product",
    { 1, "1x1" }, "kg*m/s^2", 1.0, "N", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I1", },
  { "vehicle.multibody.chassis.Subsystem.rear_downforce.PS_Product.I2",
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/rear downforce/PS Product1",
    { 1, "1x1" }, "kg/(m*s^2)", 1.0, "bar", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I1", },
  { "vehicle.multibody.chassis.Subsystem.rear_downforce.PS_Product1.I2",
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/rear downforce/PS Product2",
    { 1, "1x1" }, "m^2/s^2", 1.0, "kJ/kg", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I1", },
  { "vehicle.multibody.chassis.Subsystem.rear_downforce.PS_Product2.I2",
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/rear downforce/PS Product3",
    { 1, "1x1" }, "m^2/s^2", 1.0, "kJ/kg", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I1", },
  { "vehicle.multibody.chassis.Subsystem.rear_downforce.PS_Product3.I2",
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/rear downforce/PS Product4",
    { 1, "1x1" }, "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_DERIVED,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I1", },
  ...
  { "vehicle.multibody.chassis.Subsystem.rear_downforce.PS_Product4.O",
    ...
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/rear downforce", { 1,
      "1x1" }, "m", 1.0, "m", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "frh", }, {
...
static NeZCData s_zc_data[5] = { {
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/PS Saturation", 1U,
    0U, "vehicle.multibody.chassis.Subsystem.PS_Saturation",
    "foundation.signal.nonlinear.saturation", NE_ZC_TYPE_TRUE, }, {
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/PS Saturation", 1U,
    1U, "vehicle.multibody.chassis.Subsystem.PS_Saturation",
    "foundation.signal.nonlinear.saturation", NE_ZC_TYPE_TRUE, }, {
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/PS Saturation1", 1U,
    2U, "vehicle.multibody.chassis.Subsystem.PS_Saturation1",
    "foundation.signal.nonlinear.saturation", NE_ZC_TYPE_TRUE, }, {
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/PS Saturation1", 1U,
    3U, "vehicle.multibody.chassis.Subsystem.PS_Saturation1",
    "foundation.signal.nonlinear.saturation", NE_ZC_TYPE_TRUE, }, {
    "GVCU_HIL_simscape/vehicle/multibody/chassis/Subsystem/drag force/PS Sign",
...
NeDynamicSystem *GVCU_HIL_simscape_a37faff9_4_dae_ds(PmAllocator *allocator)
{
  NeDynamicSystem *ds;
  _NeDynamicSystem *_ds;
  ...
  ds->mMethods[NE_DS_METHOD_MDUY_P] = GVCU_HIL_simscape_a37faff9_4_ds_mduy_p;
  ...
  ds->mMethods[NE_DS_METHOD_TDUY_P] = GVCU_HIL_simscape_a37faff9_4_ds_tduy_p;
  ...
  ds->mMethods[NE_DS_METHOD_Y] = GVCU_HIL_simscape_a37faff9_4_ds_y;
  ...
  ds->mMethods[NE_DS_METHOD_DUY_P] = GVCU_HIL_simscape_a37faff9_4_ds_duy_p;
  ds->mMakeOutput[NE_DS_METHOD_DUY_P] = ds_output_duy_p;
  ds->mMethods[NE_DS_METHOD_DUY] = GVCU_HIL_simscape_a37faff9_4_ds_duy;
  ...
  ds->mMethods[NE_DS_METHOD_MODE] = GVCU_HIL_simscape_a37faff9_4_ds_mode;
  ds->mMakeOutput[NE_DS_METHOD_MODE] = ds_output_mode;
  ds->mMethods[NE_DS_METHOD_ZC] = GVCU_HIL_simscape_a37faff9_4_ds_zc;
  ...
  ds->mMethods[NE_DS_METHOD_LOG] = GVCU_HIL_simscape_a37faff9_4_ds_log;
  ...
  ds->mMethods[NE_DS_METHOD_OBS_ACT] = GVCU_HIL_simscape_a37faff9_4_ds_obs_act;
  ds->mMakeOutput[NE_DS_METHOD_OBS_ACT] = ds_output_obs_act;
  ds->mMethods[NE_DS_METHOD_OBS_ALL] = GVCU_HIL_simscape_a37faff9_4_ds_obs_all;
  ds->mMakeOutput[NE_DS_METHOD_OBS_ALL] = ds_output_obs_all;
  ds->mMethods[NE_DS_METHOD_OBS_IL] = GVCU_HIL_simscape_a37faff9_4_ds_obs_il;
