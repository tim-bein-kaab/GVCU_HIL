  ...
  NeDynamicSystemInput *t1, NeDsMethodOutput *out)
{
  ...
  out->mTDUY_P.mJc[16] = _cg_const_1[16];
  out->mTDUY_P.mJc[17] = _cg_const_1[17];
  out->mTDUY_P.mJc[18] = _cg_const_1[18];
  out->mTDUY_P.mJc[19] = _cg_const_1[19];
  out->mTDUY_P.mJc[20] = _cg_const_1[20];
  out->mTDUY_P.mJc[21] = _cg_const_1[21];
  out->mTDUY_P.mJc[22] = _cg_const_1[22];
