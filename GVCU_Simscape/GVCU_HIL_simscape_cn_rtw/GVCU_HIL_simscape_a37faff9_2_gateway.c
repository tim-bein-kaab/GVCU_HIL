...
#include "nesl_rtw.h"
#include "GVCU_HIL_simscape_a37faff9_2.h"
#include "GVCU_HIL_simscape_a37faff9_2_gateway.h"

void GVCU_HIL_simscape_a37faff9_2_gateway(void)
{
  ...
  GVCU_HIL_simscape_a37faff9_2_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group(
    "GVCU_HIL_simscape/config/Solver Configuration_2",
    1,
    &dae,
    &solverparams,
    &modelparams,
