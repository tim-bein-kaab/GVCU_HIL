...
#include "nesl_rtw.h"
#include "GVCU_HIL_simscape_a37faff9_4.h"
#include "GVCU_HIL_simscape_a37faff9_4_gateway.h"

void GVCU_HIL_simscape_a37faff9_4_gateway(void)
{
  ...
  GVCU_HIL_simscape_a37faff9_4_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group(
    "GVCU_HIL_simscape/config/Solver Configuration_4",
    1,
    &dae,
    &solverparams,
    &modelparams,
