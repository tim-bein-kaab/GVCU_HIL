...
int32_T GVCU_HIL_simscape_a37faff9_2_ds_lv(const NeDynamicSystem *LC, const
  NeDynamicSystemInput *t1, NeDsMethodOutput *out)
{
  ...
  out->mLV.mX[66] = _cg_const_1[66];
  out->mLV.mX[67] = _cg_const_1[67];
  out->mLV.mX[68] = _cg_const_1[68];
  out->mLV.mX[69] = _cg_const_1[69];
  out->mLV.mX[70] = _cg_const_1[70];
  out->mLV.mX[71] = _cg_const_1[71];
  out->mLV.mX[72] = _cg_const_1[72];
  out->mLV.mX[73] = _cg_const_1[73];
  out->mLV.mX[74] = _cg_const_1[74];
  out->mLV.mX[75] = _cg_const_1[75];
  out->mLV.mX[76] = _cg_const_1[76];
  out->mLV.mX[77] = _cg_const_1[77];
  out->mLV.mX[78] = _cg_const_1[78];
  out->mLV.mX[79] = _cg_const_1[79];
  out->mLV.mX[80] = _cg_const_1[80];
  out->mLV.mX[81] = _cg_const_1[81];
  out->mLV.mX[82] = _cg_const_1[82];
  out->mLV.mX[83] = _cg_const_1[83];
  out->mLV.mX[84] = _cg_const_1[84];
  out->mLV.mX[85] = _cg_const_1[85];
  out->mLV.mX[86] = _cg_const_1[86];
  out->mLV.mX[87] = _cg_const_1[87];
  out->mLV.mX[88] = _cg_const_1[88];
  out->mLV.mX[89] = _cg_const_1[89];
  out->mLV.mX[90] = _cg_const_1[90];
  out->mLV.mX[91] = _cg_const_1[91];
  out->mLV.mX[92] = _cg_const_1[92];
  out->mLV.mX[93] = _cg_const_1[93];
  out->mLV.mX[94] = _cg_const_1[94];
  out->mLV.mX[95] = _cg_const_1[95];
  out->mLV.mX[96] = _cg_const_1[96];
  out->mLV.mX[97] = _cg_const_1[97];
  out->mLV.mX[98] = _cg_const_1[98];
  (void)LC;
  (void)out;
  return 0;
}
