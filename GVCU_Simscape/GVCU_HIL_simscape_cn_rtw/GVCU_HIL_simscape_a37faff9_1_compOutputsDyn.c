...
PmfMessageId GVCU_HIL_simscape_a37faff9_1_compOutputsDyn(const
  ...
  *output, int *derivErr, NeuDiagnosticManager *neDiagMgr)
{
  ...
  bb[0] = sm_core_compiler_computeProximityInfoPlaneTire(
    ...
    376), (pm_math_Transform3 *)(xx + 476), xx[214], 1, (pm_math_Vector3 *)(xx +
    667), (pm_math_Vector3 *)(xx + 670));
  xx[476] = - xx[472];
  ...
  bb[1] = sm_core_compiler_computeProximityInfoPlaneTire(
    GVCU_HIL_simscape_a37faff9_1_geometry_0(NULL), (pm_math_Transform3 *)(xx +
    376), (pm_math_Transform3 *)(xx + 750), xx[151], 1, (pm_math_Vector3 *)(xx +
    676), (pm_math_Vector3 *)(xx + 757));
  xx[750] = - xx[746];
  ...
  bb[2] = sm_core_compiler_computeProximityInfoPlaneTire(
    GVCU_HIL_simscape_a37faff9_1_geometry_0(NULL), (pm_math_Transform3 *)(xx +
    376), (pm_math_Transform3 *)(xx + 809), xx[195], 1, (pm_math_Vector3 *)(xx +
    483), (pm_math_Vector3 *)(xx + 676));
  xx[801] = - xx[805];
  ...
  bb[3] = sm_core_compiler_computeProximityInfoPlaneTire(
    GVCU_HIL_simscape_a37faff9_1_geometry_0(NULL), (pm_math_Transform3 *)(xx +
    376), (pm_math_Transform3 *)(xx + 232), xx[277], 1, (pm_math_Vector3 *)(xx +
    383), (pm_math_Vector3 *)(xx + 995));
  xx[232] = - xx[1035];
