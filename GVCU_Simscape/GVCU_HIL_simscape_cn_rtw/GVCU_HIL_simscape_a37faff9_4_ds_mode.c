...
int32_T GVCU_HIL_simscape_a37faff9_4_ds_mode(const NeDynamicSystem *LC, const
  NeDynamicSystemInput *t28, NeDsMethodOutput *out)
{
  ETTSf3049b48 t2;
  ETTSf3049b48 t3;
  real_T nonscalar0[4];
  ...
  out->mMODE.mX[1ULL] = (int32_T)
    (vehicle_multibody_chassis_Subsystem_PS_Lookup_Table_2D4_I1 <= 0.13);
  out->mMODE.mX[2ULL] = (int32_T)
    ((vehicle_multibody_chassis_Subsystem_PS_Subtract1_I1 > 0.13 ? 0.13 :
      vehicle_multibody_chassis_Subsystem_PS_Subtract1_I1) >= 0.05);
  out->mMODE.mX[3ULL] = (int32_T)
    (vehicle_multibody_chassis_Subsystem_PS_Subtract1_I1 <= 0.13);
  if (t28->mU.mX[8ULL] != t28->mU.mX[8ULL]) {
    vehicle_multibody_chassis_Subsystem_PS_Lookup_Table_2D4_I1 = t28->mU.mX[8ULL];
  } else if (t28->mU.mX[8ULL] > 0.0) {
    vehicle_multibody_chassis_Subsystem_PS_Lookup_Table_2D4_I1 = 1.0;
  } else {
    vehicle_multibody_chassis_Subsystem_PS_Lookup_Table_2D4_I1 = t28->mU.mX[8ULL]
      < 0.0 ? -1.0 : 0.0;
  }

  out->mMODE.mX[4ULL] = (int32_T)
