...
#include "nesl_rtw.h"
#include "GVCU_HIL_simscape_a37faff9_3.h"
#include "GVCU_HIL_simscape_a37faff9_3_gateway.h"

void GVCU_HIL_simscape_a37faff9_3_gateway(void)
{
  ...
  GVCU_HIL_simscape_a37faff9_3_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group(
    "GVCU_HIL_simscape/config/Solver Configuration_3",
    1,
    &dae,
    &solverparams,
    &modelparams,
