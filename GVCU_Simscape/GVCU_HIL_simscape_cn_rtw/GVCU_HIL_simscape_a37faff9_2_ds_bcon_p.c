...
{
  static int32_T _cg_const_1[26] = { 0, 1, 2, 5, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8,
    8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8 };

  static int32_T _cg_const_2[8] = { 23, 24, 12, 25, 61, 11, 26, 60 };

  (void)t1;
  (void)LC;
  out->mBCON_P.mNumCol = 25ULL;
  out->mBCON_P.mNumRow = 102ULL;
