...
void Simscape_DiL_Gemera_24b_a41ef8b8_1_setTargets(const
...
void Simscape_DiL_Gemera_24b_a41ef8b8_1_initializeTrackedAngleState(const void
...
void Simscape_DiL_Gemera_24b_a41ef8b8_1_computeDiscreteState(const void *mech,
  const RuntimeDerivedValuesBundle *rtdv, const int *modeVector, double *state)
{
  const double *rtdvd = rtdv->mDoubles.mValues;
  const int *rtdvi = rtdv->mInts.mValues;
  (void) mech;
...
void Simscape_DiL_Gemera_24b_a41ef8b8_1_adjustPosition(const void *mech, const
...
void Simscape_DiL_Gemera_24b_a41ef8b8_1_perturbAsmJointPrimitiveState(const void
...
void Simscape_DiL_Gemera_24b_a41ef8b8_1_computePosDofBlendMatrix(const void
...
void Simscape_DiL_Gemera_24b_a41ef8b8_1_computeVelDofBlendMatrix(const void
  *mech, size_t stageIdx, size_t primIdx, const double *state, int partialType,
  double *matrix)
{
  (void) mech;
...
void Simscape_DiL_Gemera_24b_a41ef8b8_1_projectPartiallyTargetedPos(const void
...
void Simscape_DiL_Gemera_24b_a41ef8b8_1_propagateMotion(const void *mech, const
...
void Simscape_DiL_Gemera_24b_a41ef8b8_1_computeTransforms(const void *mech,
...
size_t Simscape_DiL_Gemera_24b_a41ef8b8_1_computeAssemblyPosError(const void
...
size_t Simscape_DiL_Gemera_24b_a41ef8b8_1_computeAssemblyJacobian(const void
...
size_t Simscape_DiL_Gemera_24b_a41ef8b8_1_computeFullAssemblyJacobian(const void
...
boolean_T Simscape_DiL_Gemera_24b_a41ef8b8_1_isInKinematicSingularity(const void
  *mech, const RuntimeDerivedValuesBundle *rtdv, size_t constraintIdx, const int
...
void Simscape_DiL_Gemera_24b_a41ef8b8_1_convertStateVector(const void *asmMech,
