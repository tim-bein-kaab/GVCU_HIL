...
#include "nesl_rtw.h"
#include "Simscape_DiL_Gemera_24b_a41ef8b8_5.h"
#include "Simscape_DiL_Gemera_24b_a41ef8b8_5_gateway.h"

void Simscape_DiL_Gemera_24b_a41ef8b8_5_gateway(void)
{
...

  {
    static const NeOutputParameters outputparameters_init[] = { { 0U, 0U }, { 0U,
        1U }, { 0U, 2U }, { 0U, 3U }, { 0U, 4U }, };

    outputparameters = outputparameters_init;
    numOutputs = sizeof(outputparameters_init)/sizeof(outputparameters_init[0]);
  }

  Simscape_DiL_Gemera_24b_a41ef8b8_5_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group(
    "Simscape_DiL_Gemera_24b/config/Solver Configuration_5",
    1,
    &dae,
    &solverparams,
    &modelparams,
