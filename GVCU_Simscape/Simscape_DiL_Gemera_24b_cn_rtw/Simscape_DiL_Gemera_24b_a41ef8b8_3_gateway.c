...
#include "nesl_rtw.h"
#include "Simscape_DiL_Gemera_24b_a41ef8b8_3.h"
#include "Simscape_DiL_Gemera_24b_a41ef8b8_3_gateway.h"

void Simscape_DiL_Gemera_24b_a41ef8b8_3_gateway(void)
{
  ...
  Simscape_DiL_Gemera_24b_a41ef8b8_3_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group(
    "Simscape_DiL_Gemera_24b/config/Solver Configuration_3",
    1,
    &dae,
    &solverparams,
    &modelparams,
