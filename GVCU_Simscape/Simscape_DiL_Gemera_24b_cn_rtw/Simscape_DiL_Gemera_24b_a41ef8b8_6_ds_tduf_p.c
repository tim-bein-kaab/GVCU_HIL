...
int32_T Simscape_DiL_Gemera_24b_a41ef8b8_6_ds_tduf_p(const NeDynamicSystem *LC,
  const NeDynamicSystemInput *t1, NeDsMethodOutput *out)
{
  static int32_T _cg_const_2[22] = { 1, 6, 2, 3, 4, 2, 3, 4, 2, 3, 4, 0, 7, 8, 9,
    7, 8, 9, 7, 8, 9, 5 };

  static int32_T _cg_const_1[12] = { 0, 1, 2, 5, 8, 11, 12, 15, 18, 21, 22, 22 };

  (void)t1;
  (void)LC;
  out->mTDUF_P.mNumCol = 11ULL;
  out->mTDUF_P.mNumRow = 10ULL;
