...
int32_T Simscape_DiL_Gemera_24b_a41ef8b8_3_ds_duf(const NeDynamicSystem *LC,
  const NeDynamicSystemInput *t7, NeDsMethodOutput *out)
{
  real_T intrm_sf_mf_4;
  real_T t2;
  real_T t6;
  real_T vehicle_powertrain_brakes_Disc_Brake3_P;
  real_T vehicle_powertrain_brakes_Disc_Brake4_P;
  (void)LC;
  ...
  vehicle_powertrain_brakes_Disc_Brake3_P = (real_T)(t7->mU.mX[2ULL] >= 0.0) *
    1.413716694115407 / 4.0 * 0.0008000000000000001;
  vehicle_powertrain_brakes_Disc_Brake4_P = (real_T)(t7->mU.mX[3ULL] >= 0.0) *
    1.413716694115407 / 4.0 * 0.0008000000000000001;
  ...
  out->mDUF.mX[2ULL] = -(t7->mU.mX[0ULL] / 0.14142135623730953 * pmf_exp
    ...
    0.14142135623730953))) * ((vehicle_powertrain_brakes_Disc_Brake3_P -
    vehicle_powertrain_brakes_Disc_Brake3_P) * 2.331643981597124) * 100000.0 +
    tanh(t7->mU.mX[0ULL] / 0.01) * vehicle_powertrain_brakes_Disc_Brake3_P *
    100000.0);
  out->mDUF.mX[3ULL] = -(t7->mU.mX[1ULL] / 0.14142135623730953 * pmf_exp
    (-(t7->mU.mX[1ULL] / 0.14142135623730953 * (t7->mU.mX[1ULL] /
    0.14142135623730953))) * ((vehicle_powertrain_brakes_Disc_Brake4_P -
    vehicle_powertrain_brakes_Disc_Brake4_P) * 2.331643981597124) * 100000.0 +
    tanh(t7->mU.mX[1ULL] / 0.01) * vehicle_powertrain_brakes_Disc_Brake4_P *
    100000.0);
  out->mDUF.mX[4ULL] = -t7->mX.mX[43ULL];
  (void)LC;
  (void)out;
  return 0;
}
