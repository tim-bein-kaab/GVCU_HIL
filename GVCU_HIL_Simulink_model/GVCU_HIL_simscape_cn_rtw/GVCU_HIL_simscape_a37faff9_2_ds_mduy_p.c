...
int32_T GVCU_HIL_simscape_a37faff9_2_ds_mduy_p(const NeDynamicSystem *LC, const
  NeDynamicSystemInput *t1, NeDsMethodOutput *out)
{
  (void)t1;
  (void)LC;
  out->mMDUY_P.mNumCol = 27ULL;
  out->mMDUY_P.mNumRow = 23ULL;
  out->mMDUY_P.mJc[0] = 0;
  out->mMDUY_P.mJc[1] = 0;
  out->mMDUY_P.mJc[2] = 0;
  out->mMDUY_P.mJc[3] = 0;
  ...
  out->mMDUY_P.mJc[16] = 0;
  out->mMDUY_P.mJc[17] = 0;
  out->mMDUY_P.mJc[18] = 0;
  out->mMDUY_P.mJc[19] = 0;
  out->mMDUY_P.mJc[20] = 0;
  out->mMDUY_P.mJc[21] = 0;
  out->mMDUY_P.mJc[22] = 0;
  out->mMDUY_P.mJc[23] = 0;
  out->mMDUY_P.mJc[24] = 0;
  out->mMDUY_P.mJc[25] = 0;
  out->mMDUY_P.mJc[26] = 0;
  out->mMDUY_P.mJc[27] = 0;
  (void)LC;
  (void)out;
  return 0;
}
