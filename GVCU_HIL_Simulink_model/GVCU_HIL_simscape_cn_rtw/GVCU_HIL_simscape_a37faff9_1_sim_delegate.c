...
void GVCU_HIL_simscape_a37faff9_1_perturbSimJointPrimitiveState(const void *mech,
...
void GVCU_HIL_simscape_a37faff9_1_perturbFlexibleBodyState(const void *mech,
...
void GVCU_HIL_simscape_a37faff9_1_constructStateVector(const void *mech, const
...
void GVCU_HIL_simscape_a37faff9_1_extractSolverStateVector(const void *mech,
...
void GVCU_HIL_simscape_a37faff9_1_extractDiscreteStateVector(const void *mech,
...
boolean_T GVCU_HIL_simscape_a37faff9_1_isPositionViolation(const void *mech,
...
boolean_T GVCU_HIL_simscape_a37faff9_1_isVelocityViolation(const void *mech,
  const RuntimeDerivedValuesBundle *rtdv, const int *eqnEnableFlags, const
  double *state, const int *modeVector)
{
  const double *rtdvd = rtdv->mDoubles.mValues;
...
PmfMessageId GVCU_HIL_simscape_a37faff9_1_projectStateSim(const void *mech,
...
void GVCU_HIL_simscape_a37faff9_1_computeConstraintError(const void *mech, const
...
boolean_T GVCU_HIL_simscape_a37faff9_1_hasJointUpwardModeChange(const void *mech,
...
PmfMessageId GVCU_HIL_simscape_a37faff9_1_performJointUpwardModeChange(const
...
void GVCU_HIL_simscape_a37faff9_1_onModeChangedCutJoints(const void *mech, const
...
void GVCU_HIL_simscape_a37faff9_1_setVariableModeJointsToLocked(const void *mech,
  int *modeVector)
{
  (void) mech;
  (void) modeVector;
