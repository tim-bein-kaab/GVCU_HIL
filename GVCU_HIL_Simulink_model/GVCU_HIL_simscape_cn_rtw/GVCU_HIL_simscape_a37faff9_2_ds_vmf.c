...
int32_T GVCU_HIL_simscape_a37faff9_2_ds_vmf(const NeDynamicSystem *LC, const
  NeDynamicSystemInput *t1, NeDsMethodOutput *out)
{
  ...
  out->mVMF.mX[66] = _cg_const_1[66];
  out->mVMF.mX[67] = _cg_const_1[67];
  out->mVMF.mX[68] = _cg_const_1[68];
  out->mVMF.mX[69] = _cg_const_1[69];
  out->mVMF.mX[70] = _cg_const_1[70];
  out->mVMF.mX[71] = _cg_const_1[71];
  out->mVMF.mX[72] = _cg_const_1[72];
  out->mVMF.mX[73] = _cg_const_1[73];
  out->mVMF.mX[74] = _cg_const_1[74];
  out->mVMF.mX[75] = _cg_const_1[75];
  out->mVMF.mX[76] = _cg_const_1[76];
  out->mVMF.mX[77] = _cg_const_1[77];
  out->mVMF.mX[78] = _cg_const_1[78];
  out->mVMF.mX[79] = _cg_const_1[79];
  out->mVMF.mX[80] = _cg_const_1[80];
  out->mVMF.mX[81] = _cg_const_1[81];
  out->mVMF.mX[82] = _cg_const_1[82];
  out->mVMF.mX[83] = _cg_const_1[83];
  out->mVMF.mX[84] = _cg_const_1[84];
  out->mVMF.mX[85] = _cg_const_1[85];
  out->mVMF.mX[86] = _cg_const_1[86];
  out->mVMF.mX[87] = _cg_const_1[87];
  out->mVMF.mX[88] = _cg_const_1[88];
  out->mVMF.mX[89] = _cg_const_1[89];
  out->mVMF.mX[90] = _cg_const_1[90];
  out->mVMF.mX[91] = _cg_const_1[91];
  out->mVMF.mX[92] = _cg_const_1[92];
  out->mVMF.mX[93] = _cg_const_1[93];
  out->mVMF.mX[94] = _cg_const_1[94];
  out->mVMF.mX[95] = _cg_const_1[95];
  out->mVMF.mX[96] = _cg_const_1[96];
  out->mVMF.mX[97] = _cg_const_1[97];
  out->mVMF.mX[98] = _cg_const_1[98];
  (void)LC;
  (void)out;
  return 0;
}
