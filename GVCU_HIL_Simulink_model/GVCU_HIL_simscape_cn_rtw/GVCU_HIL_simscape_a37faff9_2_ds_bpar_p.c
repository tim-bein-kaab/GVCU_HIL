...
int32_T GVCU_HIL_simscape_a37faff9_2_ds_bpar_p(const NeDynamicSystem *LC, const
  NeDynamicSystemInput *t1, NeDsMethodOutput *out)
{
  ...
  out->mBPAR_P.mJc[16] = 0;
  out->mBPAR_P.mJc[17] = 0;
  out->mBPAR_P.mJc[18] = 0;
  out->mBPAR_P.mJc[19] = 0;
  out->mBPAR_P.mJc[20] = 0;
  out->mBPAR_P.mJc[21] = 0;
  out->mBPAR_P.mJc[22] = 0;
