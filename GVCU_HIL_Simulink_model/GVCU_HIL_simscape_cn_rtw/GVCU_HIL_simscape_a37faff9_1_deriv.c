...
PmfMessageId GVCU_HIL_simscape_a37faff9_1_compDerivs(const
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  bb[0] = sm_core_compiler_computeProximityInfoPlaneTire(
    ...
    362), (pm_math_Transform3 *)(xx + 462), xx[185], 1, (pm_math_Vector3 *)(xx +
    650), (pm_math_Vector3 *)(xx + 653));
  xx[462] = - xx[458];
  ...
  bb[0] = sm_core_compiler_computeProximityInfoPlaneTire(
    GVCU_HIL_simscape_a37faff9_1_geometry_0(NULL), (pm_math_Transform3 *)(xx +
    362), (pm_math_Transform3 *)(xx + 656), xx[118], 1, (pm_math_Vector3 *)(xx +
    669), (pm_math_Vector3 *)(xx + 674));
  xx[656] = - xx[461];
  ...
  bb[0] = sm_core_compiler_computeProximityInfoPlaneTire(
    GVCU_HIL_simscape_a37faff9_1_geometry_0(NULL), (pm_math_Transform3 *)(xx +
    362), (pm_math_Transform3 *)(xx + 477), xx[153], 1, (pm_math_Vector3 *)(xx +
    207), (pm_math_Vector3 *)(xx + 463));
  xx[477] = - xx[165];
  ...
  bb[0] = sm_core_compiler_computeProximityInfoPlaneTire(
    GVCU_HIL_simscape_a37faff9_1_geometry_0(NULL), (pm_math_Transform3 *)(xx +
    362), (pm_math_Transform3 *)(xx + 483), xx[206], 1, (pm_math_Vector3 *)(xx +
    223), (pm_math_Vector3 *)(xx + 233));
  xx[362] = - xx[219];
...
PmfMessageId GVCU_HIL_simscape_a37faff9_1_numJacPerturbLoBounds(const
  RuntimeDerivedValuesBundle *rtdv, const int *eqnEnableFlags, const double
  *state, const int *modeVector, const double *input, const double *inputDot,
...
PmfMessageId GVCU_HIL_simscape_a37faff9_1_numJacPerturbHiBounds(const
  RuntimeDerivedValuesBundle *rtdv, const int *eqnEnableFlags, const double
  *state, const int *modeVector, const double *input, const double *inputDot,
  const double *inputDdot, const double *discreteState, double *bounds,
  NeuDiagnosticManager *neDiagMgr)
