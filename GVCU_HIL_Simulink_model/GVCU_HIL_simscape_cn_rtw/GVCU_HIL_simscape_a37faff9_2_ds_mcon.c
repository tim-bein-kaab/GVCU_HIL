...
int32_T GVCU_HIL_simscape_a37faff9_2_ds_mcon(const NeDynamicSystem *LC, const
  NeDynamicSystemInput *t1, NeDsMethodOutput *out)
{
  static real_T _cg_const_1[23] = { -0.05, -0.05, -0.02, 0.01, 0.01, 0.01, 0.01,
    1.0, 0.01, -1.0, -1.0, 0.01, -1.0, -1.0, -0.02, -0.06, -0.02, -0.02, -0.02,
    -0.02, -0.02, -0.02, -0.02 };
  ...
  out->mMCON.mX[22] = _cg_const_1[22];
  (void)LC;
  (void)out;
  return 0;
}
