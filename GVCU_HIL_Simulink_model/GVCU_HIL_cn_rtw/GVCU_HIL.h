...
/* Block signals for system '<S245>/Friction Mode' */
typedef struct {
  real_T w0;                           /* '<S245>/Friction Mode' */
  real_T win_0;                        /* '<S245>/Friction Mode' */
  real_T wout_0;                       /* '<S245>/Friction Mode' */
  boolean_T Locked;                    /* '<S245>/Friction Mode' */
} B_FrictionMode_GVCU_HIL_T;

/* Block states (default storage) for system '<S245>/Friction Mode' */
typedef struct {
  real_T lastMajorTime;                /* '<S245>/Friction Mode' */
  uint8_T is_active_c9_autolibdrivetrainc;/* '<S245>/Friction Mode' */
  uint8_T is_c9_autolibdrivetraincommon;/* '<S245>/Friction Mode' */
  uint8_T is_SlipCalc;                 /* '<S245>/Friction Mode' */
} DW_FrictionMode_GVCU_HIL_T;

/* Zero-crossing (trigger) state for system '<S245>/Friction Mode' */
typedef struct {
  ZCSigState SFunction_zcVar_ZCE;      /* '<S245>/Friction Mode' */
} ZCE_FrictionMode_GVCU_HIL_T;

/* Block signals for system '<S441>/MATLAB Function' */
typedef struct {
  real_T lambda;                       /* '<S441>/MATLAB Function' */
} B_MATLABFunction_GVCU_HIL_T;

/* Block signals for system '<S444>/MATLAB Function' */
typedef struct {
  real_T y;                            /* '<S444>/MATLAB Function' */
} B_MATLABFunction_GVCU_HIL_d_T;

/* Block signals for system '<S438>/Bristle Deflection' */
typedef struct {
  real_T Saturation3;                  /* '<S440>/Saturation3' */
  real_T po;                           /* '<S440>/Divide4' */
  real_T Switch;                       /* '<S443>/Switch' */
  real_T Gain3;                        /* '<S440>/Gain3' */
  real_T Sum;                          /* '<S440>/Sum' */
  B_MATLABFunction_GVCU_HIL_d_T sf_MATLABFunction;/* '<S444>/MATLAB Function' */
} B_BristleDeflection_GVCU_HIL_T;

/* Block states (default storage) for system '<S438>/Bristle Deflection' */
typedef struct {
  boolean_T Integrator_DWORK1;         /* '<S443>/Integrator' */
  boolean_T BristleDeflection_MODE;    /* '<S438>/Bristle Deflection' */
} DW_BristleDeflection_GVCU_HIL_T;

/* Continuous states for system '<S438>/Bristle Deflection' */
typedef struct {
  real_T Integrator_CSTATE_b;          /* '<S443>/Integrator' */
} X_BristleDeflection_GVCU_HIL_T;

/* State derivatives for system '<S438>/Bristle Deflection' */
typedef struct {
  real_T Integrator_CSTATE_b;          /* '<S443>/Integrator' */
} XDot_BristleDeflection_GVCU_H_T;

/* State Disabled for system '<S438>/Bristle Deflection' */
typedef struct {
  boolean_T Integrator_CSTATE_b;       /* '<S443>/Integrator' */
} XDis_BristleDeflection_GVCU_H_T;

/* Block signals for system '<S433>/Simple Magic Tire' */
typedef struct {
  real_T Fx;                           /* '<S433>/Simple Magic Tire' */
  real_T My;                           /* '<S433>/Simple Magic Tire' */
  real_T Kappa;                        /* '<S433>/Simple Magic Tire' */
  real_T Re;                           /* '<S433>/Simple Magic Tire' */
  real_T FzTire;                       /* '<S433>/Simple Magic Tire' */
} B_SimpleMagicTire_GVCU_HIL_T;

/* Block signals for system '<S467>/detectSlip' */
typedef struct {
  boolean_T RelationalOperator;        /* '<S480>/Relational Operator' */
} B_detectSlip_GVCU_HIL_T;

/* Block signals for system '<S467>/detectLockup' */
typedef struct {
  boolean_T CombinatorialLogic;        /* '<S475>/Combinatorial  Logic' */
} B_detectLockup_GVCU_HIL_T;

/* Block states (default storage) for system '<S467>/detectLockup' */
typedef struct {
  boolean_T UnitDelay_DSTATE;          /* '<S475>/Unit Delay' */
} DW_detectLockup_GVCU_HIL_T;

/* Block signals for system '<S467>/Slipping' */
typedef struct {
  real_T OutputInertia;                /* '<S469>/Output Inertia' */
} B_Slipping_GVCU_HIL_T;

/* Continuous states for system '<S467>/Slipping' */
typedef struct {
  real_T omegaWheel;                   /* '<S469>/omega wheel' */
} X_Slipping_GVCU_HIL_T;

/* State derivatives for system '<S467>/Slipping' */
typedef struct {
  real_T omegaWheel;                   /* '<S469>/omega wheel' */
} XDot_Slipping_GVCU_HIL_T;

/* State Disabled for system '<S467>/Slipping' */
typedef struct {
  boolean_T omegaWheel;                /* '<S469>/omega wheel' */
} XDis_Slipping_GVCU_HIL_T;

/* Block signals for system '<S462>/Clutch' */
typedef struct {
  real_T Tout;                         /* '<S462>/Clutch' */
  real_T Tfmaxs;                       /* '<S462>/Clutch' */
  real_T Tout_c;                       /* '<S462>/Clutch' */
  real_T Tfmaxs_o;                     /* '<S462>/Clutch' */
  real_T Omega;                        /* '<S462>/Clutch' */
  real_T Omegadot;                     /* '<S462>/Clutch' */
  real_T ReactionTorque;               /* '<S462>/Clutch' */
  real_T Myb;                          /* '<S462>/Clutch' */
  real_T BrkTrq;                       /* '<S462>/Clutch' */
  B_Slipping_GVCU_HIL_T Slipping;      /* '<S467>/Slipping' */
  B_detectLockup_GVCU_HIL_T detectLockup;/* '<S467>/detectLockup' */
  B_detectSlip_GVCU_HIL_T detectSlip;  /* '<S467>/detectSlip' */
} B_Clutch_GVCU_HIL_T;

/* Block states (default storage) for system '<S462>/Clutch' */
typedef struct {
  real_T lastMajorTime;                /* '<S462>/Clutch' */
  int8_T TmpIfAtSlippingInport3_ActiveSu;/* synthesized block */
  int8_T TmpIfAtLockedInport2_ActiveSubs;/* synthesized block */
  uint8_T is_active_c8_autolibshared;  /* '<S462>/Clutch' */
  uint8_T is_c8_autolibshared;         /* '<S462>/Clutch' */
  boolean_T Slipping_entered;          /* '<S462>/Clutch' */
  boolean_T Locked_entered;            /* '<S462>/Clutch' */
  DW_detectLockup_GVCU_HIL_T detectLockup;/* '<S467>/detectLockup' */
} DW_Clutch_GVCU_HIL_T;

/* Continuous states for system '<S462>/Clutch' */
typedef struct {
  X_Slipping_GVCU_HIL_T Slipping;      /* '<S467>/Slipping' */
} X_Clutch_GVCU_HIL_T;

/* State derivatives for system '<S462>/Clutch' */
typedef struct {
  XDot_Slipping_GVCU_HIL_T Slipping;   /* '<S467>/Slipping' */
} XDot_Clutch_GVCU_HIL_T;

/* State Disabled for system '<S462>/Clutch' */
typedef struct {
  XDis_Slipping_GVCU_HIL_T Slipping;   /* '<S467>/Slipping' */
} XDis_Clutch_GVCU_HIL_T;

/* Block signals for system '<S437>/Clutch' */
typedef struct {
  B_Clutch_GVCU_HIL_T sf_Clutch;       /* '<S462>/Clutch' */
} B_CoreSubsys_GVCU_HIL_T;

/* Block states (default storage) for system '<S437>/Clutch' */
typedef struct {
  DW_Clutch_GVCU_HIL_T sf_Clutch;      /* '<S462>/Clutch' */
} DW_CoreSubsys_GVCU_HIL_T;

/* Continuous states for system '<S437>/Clutch' */
typedef struct {
  X_Clutch_GVCU_HIL_T sf_Clutch;       /* '<S462>/Clutch' */
} X_CoreSubsys_GVCU_HIL_T;

/* State derivatives for system '<S437>/Clutch' */
typedef struct {
  XDot_Clutch_GVCU_HIL_T sf_Clutch;    /* '<S462>/Clutch' */
} XDot_CoreSubsys_GVCU_HIL_T;

/* State Disabled for system '<S437>/Clutch' */
typedef struct {
  XDis_Clutch_GVCU_HIL_T sf_Clutch;    /* '<S462>/Clutch' */
} XDis_CoreSubsys_GVCU_HIL_T;

/* Block signals for system '<S518>/Clutch' */
typedef struct {
  real_T Tout;                         /* '<S518>/Clutch' */
  real_T Tfmaxs;                       /* '<S518>/Clutch' */
  real_T Tout_c;                       /* '<S518>/Clutch' */
  real_T Tfmaxs_n;                     /* '<S518>/Clutch' */
  real_T Omega;                        /* '<S518>/Clutch' */
  real_T Omegadot;                     /* '<S518>/Clutch' */
  real_T ReactionTorque;               /* '<S518>/Clutch' */
  real_T Myb;                          /* '<S518>/Clutch' */
  real_T BrkTrq;                       /* '<S518>/Clutch' */
  B_Slipping_GVCU_HIL_T Slipping;      /* '<S523>/Slipping' */
  B_detectLockup_GVCU_HIL_T detectLockup;/* '<S523>/detectLockup' */
  B_detectSlip_GVCU_HIL_T detectSlip;  /* '<S523>/detectSlip' */
} B_Clutch_GVCU_HIL_b_T;

/* Block states (default storage) for system '<S518>/Clutch' */
typedef struct {
  real_T lastMajorTime;                /* '<S518>/Clutch' */
  int8_T TmpIfAtSlippingInport3_ActiveSu;/* synthesized block */
  int8_T TmpIfAtLockedInport2_ActiveSubs;/* synthesized block */
  uint8_T is_active_c8_autolibshared;  /* '<S518>/Clutch' */
  uint8_T is_c8_autolibshared;         /* '<S518>/Clutch' */
  boolean_T Slipping_entered;          /* '<S518>/Clutch' */
  boolean_T Locked_entered;            /* '<S518>/Clutch' */
  DW_detectLockup_GVCU_HIL_T detectLockup;/* '<S523>/detectLockup' */
} DW_Clutch_GVCU_HIL_g_T;

/* Continuous states for system '<S518>/Clutch' */
typedef struct {
  X_Slipping_GVCU_HIL_T Slipping;      /* '<S467>/Slipping' */
} X_Clutch_GVCU_HIL_h_T;

/* State derivatives for system '<S518>/Clutch' */
typedef struct {
  XDot_Slipping_GVCU_HIL_T Slipping;   /* '<S467>/Slipping' */
} XDot_Clutch_GVCU_HIL_g_T;

/* State Disabled for system '<S518>/Clutch' */
typedef struct {
  XDis_Slipping_GVCU_HIL_T Slipping;   /* '<S467>/Slipping' */
} XDis_Clutch_GVCU_HIL_b_T;

/* Block signals for system '<S493>/Clutch' */
typedef struct {
  B_Clutch_GVCU_HIL_b_T sf_Clutch;     /* '<S518>/Clutch' */
} B_CoreSubsys_GVCU_HIL_p_T;

/* Block states (default storage) for system '<S493>/Clutch' */
typedef struct {
  DW_Clutch_GVCU_HIL_g_T sf_Clutch;    /* '<S518>/Clutch' */
} DW_CoreSubsys_GVCU_HIL_k_T;

/* Continuous states for system '<S493>/Clutch' */
typedef struct {
  X_Clutch_GVCU_HIL_h_T sf_Clutch;     /* '<S518>/Clutch' */
} X_CoreSubsys_GVCU_HIL_d_T;

/* State derivatives for system '<S493>/Clutch' */
typedef struct {
  XDot_Clutch_GVCU_HIL_g_T sf_Clutch;  /* '<S518>/Clutch' */
} XDot_CoreSubsys_GVCU_HIL_g_T;

/* State Disabled for system '<S493>/Clutch' */
typedef struct {
  XDis_Clutch_GVCU_HIL_b_T sf_Clutch;  /* '<S518>/Clutch' */
...
typedef struct {
  ...
  real_T Gain1;                        /* '<S379>/Gain1' */
  real_T Memory;                       /* '<S238>/Memory' */
  real_T domega_o;                     /* '<S237>/domega_o' */
  real_T Subtract1;                    /* '<S237>/Subtract1' */
  real_T Signconvention;               /* '<S437>/Sign convention' */
  real_T Clock;                        /* '<S3>/Clock' */
  real_T SFunction_h;                  /* '<S46>/S-Function' */
  real_T Integrator;                   /* '<S384>/Integrator' */
  real_T VectorConcatenate2[3];        /* '<S381>/Vector Concatenate2' */
  ...
  real_T Sum;                          /* '<S379>/Sum' */
  real_T TorqueConversion;             /* '<S466>/Torque Conversion' */
  real_T Ratioofstatictokinetic;       /* '<S463>/Ratio of static to kinetic' */
  real_T Ratioofstatictokinetic1;     /* '<S463>/Ratio of static to kinetic1' */
  real_T Gain3;                        /* '<S379>/Gain3' */
  real_T Saturation_a;                 /* '<S493>/Saturation' */
  real_T Gain;                         /* '<S379>/Gain' */
  real_T Signconvention_k;             /* '<S493>/Sign convention' */
  real_T Sum1;                         /* '<S379>/Sum1' */
  real_T TorqueConversion_d;           /* '<S522>/Torque Conversion' */
  real_T Ratioofstatictokinetic_m;     /* '<S519>/Ratio of static to kinetic' */
  real_T Ratioofstatictokinetic1_g;   /* '<S519>/Ratio of static to kinetic1' */
  real_T Gain2;                        /* '<S379>/Gain2' */
  real_T Gain7;                        /* '<S376>/Gain7' */
  real_T Clf;                          /* '<S376>/Gain8' */
  real_T Clr;                          /* '<S376>/Gain9' */
  real_T FAero[3];                     /* '<S376>/Matrix Concatenate1' */
  real_T UnaryMinus[3];                /* '<S384>/Unary Minus' */
  real_T VectorConcatenate[6];         /* '<S421>/Vector Concatenate' */
  real_T Saturation_p;                 /* '<S421>/Saturation' */
  real_T Gain_f;                       /* '<S543>/Gain' */
  real_T Product1;                     /* '<S384>/Product1' */
  real_T xddot;                        /* '<S384>/1//m' */
  real_T UnitConversion[3];            /* '<S392>/Unit Conversion' */
  ...
  real_T Product;                      /* '<S116>/Product' */
  real_T Sum8;                         /* '<S39>/Sum8' */
  real_T kmh;                          /* '<S3>/m//s to km//h' */
  real_T Spd;                          /* '<S302>/Integrator' */
  real_T rpm;                          /* '<S8>/Gain1' */
  real_T uDLookupTable;                /* '<S8>/1-D Lookup Table' */
  real_T SFunction_p4;                 /* '<S203>/S-Function' */
  real_T TransferFcn;                  /* '<S198>/Transfer Fcn' */
  real_T Gain1_i;                      /* '<S210>/Gain1' */
  real_T Switch_a;                     /* '<S210>/Switch' */
  real_T Gain1_g;                      /* '<S212>/Gain1' */
  real_T Divide_b;                     /* '<S221>/Divide' */
  real_T SFunction_g;                  /* '<S201>/S-Function' */
  real_T rads;                         /* '<S8>/Gain2' */
  real_T rpm_l;                        /* '<S200>/Subtract1' */
  real_T SumI4;                        /* '<S350>/SumI4' */
  real_T Clock_p;                      /* '<S200>/Clock' */
  real_T Add_f;                        /* '<S200>/Add' */
  real_T Integrator_d;                 /* '<S358>/Integrator' */
  real_T Saturation_c;                 /* '<S365>/Saturation' */
  real_T SFunction_e;                  /* '<S202>/S-Function' */
  real_T Switch2;                      /* '<S8>/Switch2' */
  real_T Sum_h;                        /* '<S225>/Sum' */
  real_T EMTrq;                        /* '<S198>/Product1' */
  real_T Omega[4];                     /* '<S426>/Matrix Concatenate23' */
  real_T VectorConcatenate4[2];        /* '<S313>/Vector Concatenate4' */
  real_T VectorConcatenate5[2];        /* '<S313>/Vector Concatenate5' */
  real_T Memory_a;                     /* '<S314>/Memory' */
  real_T VectorConcatenate2_l[2];      /* '<S313>/Vector Concatenate2' */
  real_T VectorConcatenate3[2];        /* '<S313>/Vector Concatenate3' */
  real_T Subtract1_j[2];               /* '<S313>/Subtract1' */
  real_T Add_c;                        /* '<S245>/Add' */
  real_T Ratioofstatictokinetic_i;     /* '<S263>/Ratio of static to kinetic' */
  real_T IC;                           /* '<S253>/IC' */
  real_T Switch_p;                     /* '<S253>/Switch' */
  real_T IC_e;                         /* '<S254>/IC' */
  real_T Switch_f;                     /* '<S254>/Switch' */
  real_T IC_l;                         /* '<S249>/IC' */
  real_T Switch_c;                     /* '<S249>/Switch' */
  real_T Subtract_k;                   /* '<S237>/Subtract' */
  real_T Product_i;                    /* '<S238>/Product' */
  real_T Divide_c;                     /* '<S264>/Divide' */
  real_T Saturation_m;                 /* '<S2>/Saturation' */
  real_T Product_ie;                   /* '<S265>/Product' */
  real_T SpdRatio;                     /* '<S245>/Merge2' */
  real_T Memory_k;                     /* '<S270>/Memory' */
  real_T domega_o_a;                   /* '<S269>/domega_o' */
  real_T Add_d;                        /* '<S277>/Add' */
  real_T Ratioofstatictokinetic_n;     /* '<S295>/Ratio of static to kinetic' */
  real_T IC_e4;                        /* '<S285>/IC' */
  real_T Switch_c3;                    /* '<S285>/Switch' */
  real_T IC_p;                         /* '<S286>/IC' */
  real_T Switch_j;                     /* '<S286>/Switch' */
  real_T IC_j;                         /* '<S281>/IC' */
  real_T Switch_o;                     /* '<S281>/Switch' */
  real_T Subtract_h;                   /* '<S269>/Subtract' */
  real_T Product_g;                    /* '<S270>/Product' */
  real_T Divide_i;                     /* '<S296>/Divide' */
  real_T Saturation1;                  /* '<S2>/Saturation1' */
  real_T Product_p;                    /* '<S297>/Product' */
  real_T SpdRatio_o;                   /* '<S277>/Merge2' */
  real_T rpm_g;                        /* '<S199>/Gain2' */
  real_T Switch_n;                     /* '<S304>/Switch' */
  real_T Divide_l;                     /* '<S302>/Divide' */
  real_T VectorConcatenate1[2];        /* '<S313>/Vector Concatenate1' */
  real_T Subtract_b[2];                /* '<S313>/Subtract' */
  real_T Product_f[2];                 /* '<S314>/Product' */
  real_T MAero[3];                     /* '<S376>/Matrix Concatenate2' */
  real_T kmh_e;                        /* '<S10>/Gain' */
  real_T Product2;                     /* '<S384>/Product2' */
  real_T Fz;                           /* '<S393>/1//NF' */
  real_T Fz_n;                         /* '<S393>/1//NR' */
  real_T Transpose[9];                 /* '<S383>/Transpose' */
  real_T Product_n;                    /* '<S452>/Product' */
  real_T Product3;                     /* '<S452>/Product3' */
  real_T Product4;                     /* '<S452>/Product4' */
  real_T Product9;                     /* '<S452>/Product9' */
  real_T Product_b;                    /* '<S481>/Product' */
  real_T Product_gx;                   /* '<S508>/Product' */
  real_T Product3_p;                   /* '<S508>/Product3' */
  real_T Product4_k;                   /* '<S508>/Product4' */
  real_T Product9_j;                   /* '<S508>/Product9' */
  real_T Product_l;                    /* '<S537>/Product' */
  ...
  real_T SFunction_ep;                 /* '<S135>/S-Function' */
  ...
  real_T SFunction_hp;                 /* '<S134>/S-Function' */
  real_T SFunction_gn;                 /* '<S136>/S-Function' */
  real_T SFunction_bs;                 /* '<S173>/S-Function' */
  ...
  real_T SFunction_c4;                 /* '<S170>/S-Function' */
  real_T SFunction_pu;                 /* '<S171>/S-Function' */
  real_T SFunction_bx;                 /* '<S172>/S-Function' */
  ...
  real_T Gain1_o;                      /* '<S11>/Gain1' */
  real_T Gain2_n;                      /* '<S11>/Gain2' */
  real_T Gain3_b;                      /* '<S11>/Gain3' */
  real_T Gain4;                        /* '<S11>/Gain4' */
  real_T InputInertia;                 /* '<S284>/Input Inertia' */
  real_T OutputInertia;                /* '<S284>/Output Inertia' */
  real_T Inertia;                      /* '<S283>/Inertia' */
  real_T InputInertia_b;               /* '<S252>/Input Inertia' */
  real_T OutputInertia_a;              /* '<S252>/Output Inertia' */
  real_T Inertia_f;                    /* '<S251>/Inertia' */
  ...
  boolean_T RelationalOperator;        /* '<S438>/Relational Operator' */
  boolean_T HiddenBuf_InsertedFor_BristleDe;/* '<S438>/Relational Operator' */
  boolean_T RelationalOperator_b;      /* '<S494>/Relational Operator' */
  boolean_T HiddenBuf_InsertedFor_Bristle_k;/* '<S494>/Relational Operator' */
  B_MATLABFunction_GVCU_HIL_d_T sf_MATLABFunction_g;/* '<S538>/MATLAB Function' */
  B_CoreSubsys_GVCU_HIL_p_T CoreSubsys_h[1];/* '<S493>/Clutch' */
  B_SimpleMagicTire_GVCU_HIL_T sf_SimpleMagicTire_n;/* '<S489>/Simple Magic Tire' */
  B_BristleDeflection_GVCU_HIL_T BristleDeflection_h;/* '<S494>/Bristle Deflection' */
  B_MATLABFunction_GVCU_HIL_T sf_MATLABFunction_k;/* '<S497>/MATLAB Function' */
  B_MATLABFunction_GVCU_HIL_d_T sf_MATLABFunction_i;/* '<S482>/MATLAB Function' */
  B_CoreSubsys_GVCU_HIL_T CoreSubsys[1];/* '<S437>/Clutch' */
  B_SimpleMagicTire_GVCU_HIL_T sf_SimpleMagicTire;/* '<S433>/Simple Magic Tire' */
  B_BristleDeflection_GVCU_HIL_T BristleDeflection;/* '<S438>/Bristle Deflection' */
  B_MATLABFunction_GVCU_HIL_T sf_MATLABFunction_h;/* '<S441>/MATLAB Function' */
  B_FrictionMode_GVCU_HIL_T sf_FrictionMode_n;/* '<S277>/Friction Mode' */
  B_FrictionMode_GVCU_HIL_T sf_FrictionMode;/* '<S245>/Friction Mode' */
} B_GVCU_HIL_T;
...
typedef struct {
  ...
  real_T Memory_PreviousInput_h;       /* '<S314>/Memory' */
  real_T Memory_PreviousInput_j;       /* '<S270>/Memory' */
  ...
  real_T stop_ts;                      /* '<S200>/MATLAB Function' */
  ...
  void* SFunction_SysVar_as;           /* '<S427>/S-Function' */
  void* SFunction_SysVar_d;            /* '<S428>/S-Function' */
  void* SFunction_SysVar_ca;           /* '<S429>/S-Function' */
  ...
  void* SFunction_SysVar_j;            /* '<S159>/S-Function' */
  void* SFunction_SysVar_pv;           /* '<S160>/S-Function' */
  void *TransportDelay1_PWORK[2];      /* '<S6>/Transport Delay1' */
  void* SFunction_SysVar_d3;           /* '<S191>/S-Function' */
  void* SFunction_SysVar_pa;           /* '<S175>/S-Function' */
  void* SFunction_SysVar_n;            /* '<S176>/S-Function' */
  void* SFunction_SysVar_er;           /* '<S177>/S-Function' */
  void* SFunction_SysVar_g;            /* '<S178>/S-Function' */
  void* SFunction_SysVar_k;            /* '<S179>/S-Function' */
  void* SFunction_SysVar_e0;           /* '<S181>/S-Function' */
  void* SFunction_SysVar_lf;           /* '<S180>/S-Function' */
  void* SFunction_SysVar_mc;           /* '<S192>/S-Function' */
  void* SFunction_SysVar_py;           /* '<S182>/S-Function' */
  void* SFunction_SysVar_fl;           /* '<S183>/S-Function' */
  void* SFunction_SysVar_ko;           /* '<S184>/S-Function' */
  void* SFunction_SysVar_m4;           /* '<S185>/S-Function' */
  void* SFunction_SysVar_lv;           /* '<S186>/S-Function' */
  void* SFunction_SysVar_mn;           /* '<S187>/S-Function' */
  void* SFunction_SysVar_la;           /* '<S188>/S-Function' */
  void* SFunction_SysVar_kr;           /* '<S189>/S-Function' */
  void* SFunction_SysVar_da;           /* '<S190>/S-Function' */
  void* SFunction_SysVar_dc;           /* '<S193>/S-Function' */
  void* SFunction_SysVar_c5;           /* '<S194>/S-Function' */
  void* SFunction_SysVar_pi;           /* '<S174>/S-Function' */
  void* SFunction_SysVar_mm;           /* '<S195>/S-Function' */
  void* SFunction_SysVar_flp;          /* '<S196>/S-Function' */
  void* SFunction_SysVar_df;           /* '<S545>/S-Function' */
  ...
  int8_T Integrator_PrevResetState_c;  /* '<S358>/Integrator' */
  int8_T If_ActiveSubsystem;           /* '<S245>/If' */
  int8_T If_ActiveSubsystem_o;         /* '<S277>/If' */
  uint8_T RateTransition_Buffer_j;     /* '<S6>/Rate Transition' */
  uint8_T RateTransition1_Buffer_c;    /* '<S6>/Rate Transition1' */
  boolean_T Integrator_DWORK1;         /* '<S238>/Integrator' */
  boolean_T Relay_Mode;                /* '<S59>/Relay' */
  boolean_T PrevLimited;               /* '<S3>/Rate Limiter1' */
  boolean_T IntegratorLimited_DWORK1;  /* '<S210>/Integrator Limited' */
  boolean_T Integrator_DWORK1_f;       /* '<S313>/Integrator' */
  boolean_T Integrator_DWORK1_m;       /* '<S314>/Integrator' */
  boolean_T IC_FirstOutputTime;        /* '<S253>/IC' */
  boolean_T IC_FirstOutputTime_m;      /* '<S254>/IC' */
  boolean_T IC_FirstOutputTime_c;      /* '<S249>/IC' */
  boolean_T Integrator_DWORK1_d;       /* '<S270>/Integrator' */
  boolean_T IC_FirstOutputTime_ca;     /* '<S285>/IC' */
  boolean_T IC_FirstOutputTime_n;      /* '<S286>/IC' */
  boolean_T IC_FirstOutputTime_g;      /* '<S281>/IC' */
  boolean_T fired;                     /* '<S200>/MATLAB Function' */
  boolean_T InputIntegrator_DWORK1;    /* '<S284>/Input Integrator' */
  boolean_T OutputIntegrator_DWORK1;   /* '<S284>/Output Integrator' */
  boolean_T LockedShaftIntegrator_DWORK1;/* '<S283>/Locked Shaft Integrator' */
  boolean_T InputIntegrator_DWORK1_f;  /* '<S252>/Input Integrator' */
  boolean_T OutputIntegrator_DWORK1_f; /* '<S252>/Output Integrator' */
  boolean_T LockedShaftIntegrator_DWORK1_d;/* '<S251>/Locked Shaft Integrator' */
  boolean_T main_state_not_empty;      /* '<S3>/MATLAB Function2' */
  boolean_T freq_not_empty;            /* '<S3>/MATLAB Function2' */
  DW_CoreSubsys_GVCU_HIL_k_T CoreSubsys_h[1];/* '<S493>/Clutch' */
  DW_BristleDeflection_GVCU_HIL_T BristleDeflection_h;/* '<S494>/Bristle Deflection' */
  DW_CoreSubsys_GVCU_HIL_T CoreSubsys[1];/* '<S437>/Clutch' */
  DW_BristleDeflection_GVCU_HIL_T BristleDeflection;/* '<S438>/Bristle Deflection' */
  DW_FrictionMode_GVCU_HIL_T sf_FrictionMode_n;/* '<S277>/Friction Mode' */
  DW_FrictionMode_GVCU_HIL_T sf_FrictionMode;/* '<S245>/Friction Mode' */
} DW_GVCU_HIL_T;

/* Continuous states (default storage) */
typedef struct {
  real_T Integrator_CSTATE;            /* '<S238>/Integrator' */
  real_T Integrator_CSTATE_j;          /* '<S237>/Integrator' */
  real_T Integrator_CSTATE_a;          /* '<S481>/Integrator' */
  real_T Integrator_CSTATE_k;          /* '<S384>/Integrator' */
  real_T Integrator_CSTATE_i;          /* '<S116>/Integrator' */
  real_T Integrator1_CSTATE;           /* '<S39>/Integrator1' */
  real_T Integrator_CSTATE_e;          /* '<S537>/Integrator' */
  real_T Integrator_CSTATE_n;          /* '<S302>/Integrator' */
  real_T TransferFcn_CSTATE;           /* '<S198>/Transfer Fcn' */
  real_T IntegratorLimited_CSTATE;     /* '<S210>/Integrator Limited' */
  real_T Integrator_CSTATE_g;          /* '<S225>/Integrator' */
  real_T Integrator_CSTATE_f[2];       /* '<S313>/Integrator' */
  real_T Integrator_CSTATE_d[2];       /* '<S314>/Integrator' */
  real_T Integrator_CSTATE_fz;         /* '<S265>/Integrator' */
  real_T TransferFcn_CSTATE_o;         /* '<S35>/Transfer Fcn' */
  real_T Integrator_CSTATE_m;          /* '<S270>/Integrator' */
  real_T Integrator_CSTATE_l;          /* '<S269>/Integrator' */
  real_T Integrator_CSTATE_k0;         /* '<S297>/Integrator' */
  real_T TransferFcn_CSTATE_oq;        /* '<S36>/Transfer Fcn' */
  real_T Integrator3_CSTATE;           /* '<S392>/Integrator3' */
  real_T Integrator1_CSTATE_c;         /* '<S381>/Integrator1' */
  real_T TransferFcn_CSTATE_m;         /* '<S37>/Transfer Fcn' */
  real_T TransferFcn_CSTATE_l;         /* '<S38>/Transfer Fcn' */
  X_CoreSubsys_GVCU_HIL_d_T CoreSubsys_h[1];/* '<S518>/CoreSubsys' */
  X_BristleDeflection_GVCU_HIL_T BristleDeflection_h;/* '<S438>/Bristle Deflection' */
  X_CoreSubsys_GVCU_HIL_T CoreSubsys[1];/* '<S462>/CoreSubsys' */
  X_BristleDeflection_GVCU_HIL_T BristleDeflection;/* '<S438>/Bristle Deflection' */
  real_T InputIntegrator_CSTATE;       /* '<S284>/Input Integrator' */
  real_T OutputIntegrator_CSTATE;      /* '<S284>/Output Integrator' */
  real_T LockedShaftIntegrator_CSTATE; /* '<S283>/Locked Shaft Integrator' */
  real_T InputIntegrator_CSTATE_k;     /* '<S252>/Input Integrator' */
  real_T OutputIntegrator_CSTATE_g;    /* '<S252>/Output Integrator' */
  real_T LockedShaftIntegrator_CSTATE_m;/* '<S251>/Locked Shaft Integrator' */
} X_GVCU_HIL_T;
...
typedef struct {
  ...
  real_T TransferFcn_CSTATE_m;         /* '<S37>/Transfer Fcn' */
  real_T TransferFcn_CSTATE_l;         /* '<S38>/Transfer Fcn' */
  XDot_CoreSubsys_GVCU_HIL_g_T CoreSubsys_h[1];/* '<S518>/CoreSubsys' */
  XDot_BristleDeflection_GVCU_H_T BristleDeflection_h;/* '<S438>/Bristle Deflection' */
  XDot_CoreSubsys_GVCU_HIL_T CoreSubsys[1];/* '<S462>/CoreSubsys' */
  XDot_BristleDeflection_GVCU_H_T BristleDeflection;/* '<S438>/Bristle Deflection' */
  real_T InputIntegrator_CSTATE;       /* '<S284>/Input Integrator' */
  real_T OutputIntegrator_CSTATE;      /* '<S284>/Output Integrator' */
  real_T LockedShaftIntegrator_CSTATE; /* '<S283>/Locked Shaft Integrator' */
  real_T InputIntegrator_CSTATE_k;     /* '<S252>/Input Integrator' */
...
/* State disabled  */
typedef struct {
  boolean_T Integrator_CSTATE;         /* '<S238>/Integrator' */
  boolean_T Integrator_CSTATE_j;       /* '<S237>/Integrator' */
  boolean_T Integrator_CSTATE_a;       /* '<S481>/Integrator' */
  boolean_T Integrator_CSTATE_k;       /* '<S384>/Integrator' */
  boolean_T Integrator_CSTATE_i;       /* '<S116>/Integrator' */
  boolean_T Integrator1_CSTATE;        /* '<S39>/Integrator1' */
  boolean_T Integrator_CSTATE_e;       /* '<S537>/Integrator' */
  boolean_T Integrator_CSTATE_n;       /* '<S302>/Integrator' */
  boolean_T TransferFcn_CSTATE;        /* '<S198>/Transfer Fcn' */
  boolean_T IntegratorLimited_CSTATE;  /* '<S210>/Integrator Limited' */
  boolean_T Integrator_CSTATE_g;       /* '<S225>/Integrator' */
  boolean_T Integrator_CSTATE_f[2];    /* '<S313>/Integrator' */
  boolean_T Integrator_CSTATE_d[2];    /* '<S314>/Integrator' */
  boolean_T Integrator_CSTATE_fz;      /* '<S265>/Integrator' */
  boolean_T TransferFcn_CSTATE_o;      /* '<S35>/Transfer Fcn' */
  boolean_T Integrator_CSTATE_m;       /* '<S270>/Integrator' */
  boolean_T Integrator_CSTATE_l;       /* '<S269>/Integrator' */
  boolean_T Integrator_CSTATE_k0;      /* '<S297>/Integrator' */
  boolean_T TransferFcn_CSTATE_oq;     /* '<S36>/Transfer Fcn' */
  boolean_T Integrator3_CSTATE;        /* '<S392>/Integrator3' */
  boolean_T Integrator1_CSTATE_c;      /* '<S381>/Integrator1' */
  boolean_T TransferFcn_CSTATE_m;      /* '<S37>/Transfer Fcn' */
  boolean_T TransferFcn_CSTATE_l;      /* '<S38>/Transfer Fcn' */
  XDis_CoreSubsys_GVCU_HIL_o_T CoreSubsys_h[1];/* '<S518>/CoreSubsys' */
  XDis_BristleDeflection_GVCU_H_T BristleDeflection_h;/* '<S438>/Bristle Deflection' */
  XDis_CoreSubsys_GVCU_HIL_T CoreSubsys[1];/* '<S462>/CoreSubsys' */
  XDis_BristleDeflection_GVCU_H_T BristleDeflection;/* '<S438>/Bristle Deflection' */
  boolean_T InputIntegrator_CSTATE;    /* '<S284>/Input Integrator' */
  boolean_T OutputIntegrator_CSTATE;   /* '<S284>/Output Integrator' */
  boolean_T LockedShaftIntegrator_CSTATE;/* '<S283>/Locked Shaft Integrator' */
  boolean_T InputIntegrator_CSTATE_k;  /* '<S252>/Input Integrator' */
  boolean_T OutputIntegrator_CSTATE_g; /* '<S252>/Output Integrator' */
  boolean_T LockedShaftIntegrator_CSTATE_m;/* '<S251>/Locked Shaft Integrator' */
} XDis_GVCU_HIL_T;

/* Zero-crossing (trigger) state */
typedef struct {
  ZCSigState Integrator_Reset_ZCE;     /* '<S238>/Integrator' */
  ZCSigState Integrator1_Reset_ZCE;    /* '<S39>/Integrator1' */
  ZCSigState Integrator_Reset_ZCE_l;   /* '<S314>/Integrator' */
  ZCSigState Integrator_Reset_ZCE_g;   /* '<S270>/Integrator' */
  ZCE_FrictionMode_GVCU_HIL_T sf_FrictionMode_n;/* '<S277>/Friction Mode' */
  ZCE_FrictionMode_GVCU_HIL_T sf_FrictionMode;/* '<S245>/Friction Mode' */
} PrevZCX_GVCU_HIL_T;
...
struct P_BristleDeflection_GVCU_HIL_T_ {
  ...
  real_T Saturation3_UpperSat;         /* Expression: 2
                                        * Referenced by: '<S440>/Saturation3'
                                        */
  ...
  real_T Gain3_Gain;                   /* Expression: 0.1
                                        * Referenced by: '<S440>/Gain3'
                                        */
  real_T Saturation2_UpperSat;         /* Expression: inf
                                        * Referenced by: '<S440>/Saturation2'
                                        */
...
struct P_detectLockup_GVCU_HIL_T_ {
  ...
  boolean_T CombinatorialLogic_table[8];
                                  ...
                                  * Referenced by: '<S475>/Combinatorial  Logic'
                                  */
};
...
struct P_Slipping_GVCU_HIL_T_ {
  real_T u_Gain;                       /* Expression: -4
                                        * Referenced by: '<S469>/-4'
                                        */
};

/* Parameters for system: '<S462>/Clutch' */
struct P_Clutch_GVCU_HIL_T_ {
  P_Slipping_GVCU_HIL_T Slipping;      /* '<S467>/Slipping' */
  P_Locked_GVCU_HIL_T Locked;          /* '<S467>/Locked' */
  P_detectLockup_GVCU_HIL_T detectLockup;/* '<S467>/detectLockup' */
  P_detectSlip_GVCU_HIL_T detectSlip;  /* '<S467>/detectSlip' */
};

/* Parameters for system: '<S437>/Clutch' */
struct P_CoreSubsys_GVCU_HIL_T_ {
  P_Clutch_GVCU_HIL_T sf_Clutch;       /* '<S462>/Clutch' */
};

/* Parameters for system: '<S518>/Clutch' */
struct P_Clutch_GVCU_HIL_k_T_ {
  P_Slipping_GVCU_HIL_T Slipping;      /* '<S523>/Slipping' */
  P_Locked_GVCU_HIL_T Locked;          /* '<S523>/Locked' */
  P_detectLockup_GVCU_HIL_T detectLockup;/* '<S523>/detectLockup' */
  P_detectSlip_GVCU_HIL_T detectSlip;  /* '<S523>/detectSlip' */
};

/* Parameters for system: '<S493>/Clutch' */
struct P_CoreSubsys_GVCU_HIL_b_T_ {
  P_Clutch_GVCU_HIL_k_T sf_Clutch;     /* '<S518>/Clutch' */
};
...
struct P_GVCU_HIL_T_ {
  struct_4XugGcFnmI8vVYapTNIxNC veh;   /* Variable: veh
                                        ...
                                        *   '<S376>/Gain4'
                                        *   '<S376>/Gain5'
                                        *   '<S376>/2-D Lookup Table2'
                                        *   '<S376>/2-D Lookup Table3'
                                        *   '<S376>/2-D Lookup Table4'
                                        *   '<S380>/Constant'
                                        *   '<S384>/1//(a+b)'
                                        *   '<S384>/1//(a+b) '
                                        *   '<S384>/1//m'
                                        ...
                                        *   '<S421>/.5.*A.*Pabs.//R.//T'
                                        *   '<S462>/Clutch'
                                        *   '<S463>/Ratio of static to kinetic'
                                        *   '<S463>/Ratio of static to kinetic1'
                                        *   '<S464>/Saturation'
                                        *   '<S518>/Clutch'
                                        *   '<S519>/Ratio of static to kinetic'
                                        *   '<S519>/Ratio of static to kinetic1'
                                        *   '<S520>/Saturation'
                                        *   '<S395>/R_T1'
                                        *   '<S395>/R_T3'
                                        *   '<S396>/R_T1'
                                        *   '<S396>/R_T3'
                                        *   '<S466>/Disk brake actuator bore'
                                        *   '<S466>/Number of brake pads'
                                        *   '<S466>/Torque Conversion'
                                        *   '<S522>/Disk brake actuator bore'
                                        *   '<S522>/Number of brake pads'
                                        *   '<S522>/Torque Conversion'
                                        */
  ...
  real_T VehicleBody1DOFLongitudinal_Pab;
                               ...
                               * Referenced by: '<S421>/.5.*A.*Pabs.//R.//T'
                               */
  ...
  real_T VehicleBody1DOFLongitudinal_T;
                                 ...
                                 * Referenced by: '<S378>/AirTempConstant'
                                 */
  ...
  real_T FrontLongitudinalWheelDiscBra_f;
                               ...
                               * Referenced by:
                               *   '<S433>/Simple Magic Tire'
                               *   '<S438>/Bristle Deflection'
                               *   '<S438>/VXLOW'
                               *   '<S462>/Clutch'
                               *   '<S464>/Saturation'
  ...
  real_T RearLongitudinalWheelDiscBrak_n;
                               ...
                               * Referenced by:
                               *   '<S489>/Simple Magic Tire'
                               *   '<S494>/Bristle Deflection'
                               *   '<S494>/VXLOW'
                               *   '<S518>/Clutch'
                               *   '<S520>/Saturation'
                               *   '<S538>/MATLAB Function'
  ...
  real_T FrontLongitudinalWheelDiscBr_cx;
                               ...
                               * Referenced by: '<S424>/lam_muxConstant'
                               */
  ...
  real_T LockedShaftIntegrator_UpperSat;/* Expression: maxAbsSpd
                                         * Referenced by: '<S251>/Locked Shaft Integrator'
                                         */
  ...
  real_T Signconvention_Gain;          /* Expression: -1
                                        * Referenced by: '<S437>/Sign convention'
                                        */
  ...
  real_T TorqueConversion1_Gain;       /* Expression: pi/4
                                        * Referenced by: '<S466>/Torque Conversion1'
                                        */
  real_T DisallowNegativeBrakeTorque_Upp;/* Expression: inf
                                          * Referenced by: '<S466>/Disallow Negative Brake Torque'
                                          */
  ...
  real_T TirePrsConstant_Value;        /* Expression: 0
                                        * Referenced by: '<S424>/TirePrsConstant'
                                        */
  ...
  real_T Signconvention_Gain_k;        /* Expression: -1
                                        * Referenced by: '<S493>/Sign convention'
                                        */
  real_T TorqueConversion1_Gain_e;     /* Expression: pi/4
                                        * Referenced by: '<S522>/Torque Conversion1'
                                        */
  real_T DisallowNegativeBrakeTorque_U_k;/* Expression: inf
                                          * Referenced by: '<S522>/Disallow Negative Brake Torque'
                                          */
  ...
  real_T Constant7_Value_n;            /* Expression: B
                                        * Referenced by: '<S514>/Constant7'
                                        */
  real_T Constant6_Value_a;            /* Expression: E
                                        * Referenced by: '<S514>/Constant6'
                                        */
  ...
  real_T Constant4_Value_l0;           /* Expression: 1
                                        * Referenced by: '<S495>/Constant4'
                                        */
  real_T DeadZone_Start_f;             /* Expression: -.01
                                        * Referenced by: '<S494>/Dead Zone'
                                        */
  ...
  real_T IC_Value;                     /* Expression: 0
                                        * Referenced by: '<S253>/IC'
                                        */
  real_T Switch_Threshold_f;           /* Expression: 0
                                        * Referenced by: '<S253>/Switch'
                                        */
  ...
  real_T GndConstant_Value;            /* Expression: Gndz
                                        * Referenced by: '<S424>/GndConstant'
                                        */
  ...
  real_T SFunction_1_P1_Size_a[2];  /* Computed Parameter: SFunction_1_P1_Size_a
                                     * Referenced by: '<S162>/S-Function_1'
                                     */
  ...
  real_T SFunction_1_P9_fc[9];         /* Computed Parameter: SFunction_1_P9_fc
                                        * Referenced by: '<S169>/S-Function_1'
                                        */
  real_T Gain1_Gain_i;                 /* Expression: 0.159154943
                                        * Referenced by: '<S11>/Gain1'
                                        */
  real_T Gain2_Gain_a;                 /* Expression: 0.159154943
                                        * Referenced by: '<S11>/Gain2'
                                        */
  real_T Gain3_Gain_c;                 /* Expression: 0.159154943
  ...
  uint8_T Constant21_Value_i;          /* Computed Parameter: Constant21_Value_i
                                        ...
                                        */
  P_CoreSubsys_GVCU_HIL_b_T CoreSubsys_h;/* '<S493>/Clutch' */
  P_BristleDeflection_GVCU_HIL_T BristleDeflection_h;/* '<S494>/Bristle Deflection' */
  P_CoreSubsys_GVCU_HIL_T CoreSubsys;  /* '<S437>/Clutch' */
  P_BristleDeflection_GVCU_HIL_T BristleDeflection;/* '<S438>/Bristle Deflection' */
};
 ...
 * '<S61>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller'
 * '<S62>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Anti-windup'
 * '<S63>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/D Gain'
 * '<S64>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/External Derivative'
 * '<S65>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Filter'
 * '<S66>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Filter ICs'
 * '<S67>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/I Gain'
 * '<S68>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Ideal P Gain'
 * '<S69>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Ideal P Gain Fdbk'
 * '<S70>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Integrator'
 * '<S71>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Integrator ICs'
 * '<S72>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/N Copy'
 * '<S73>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/N Gain'
 * '<S74>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/P Copy'
 * '<S75>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Parallel P Gain'
 * '<S76>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Reset Signal'
 * '<S77>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Saturation'
 * '<S78>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Saturation Fdbk'
 * '<S79>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Sum'
 * '<S80>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Sum Fdbk'
 * '<S81>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Tracking Mode'
 * '<S82>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Tracking Mode Sum'
 * '<S83>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Tsamp - Integral'
 * '<S84>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Tsamp - Ngain'
 * '<S85>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/postSat Signal'
 * '<S86>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/preInt Signal'
 * '<S87>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/preSat Signal'
 * '<S88>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Anti-windup/Disc. Clamping Parallel'
 * '<S89>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Anti-windup/Disc. Clamping Parallel/Dead Zone'
 * '<S90>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Anti-windup/Disc. Clamping Parallel/Dead Zone/Enabled'
 * '<S91>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/D Gain/Disabled'
 * '<S92>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/External Derivative/Disabled'
 * '<S93>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Filter/Disabled'
 * '<S94>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Filter ICs/Disabled'
 * '<S95>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/I Gain/Internal Parameters'
 * '<S96>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Ideal P Gain/Passthrough'
 * '<S97>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Ideal P Gain Fdbk/Disabled'
 * '<S98>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Integrator/Discrete'
 * '<S99>'  : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Integrator ICs/Internal IC'
 * '<S100>' : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/N Copy/Disabled wSignal Specification'
 * '<S101>' : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/N Gain/Disabled'
 * '<S102>' : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/P Copy/Disabled'
 * '<S103>' : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Parallel P Gain/Internal Parameters'
 * '<S104>' : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Reset Signal/External Reset'
 * '<S105>' : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Saturation/Enabled'
 * '<S106>' : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Saturation Fdbk/Disabled'
 * '<S107>' : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Sum/Sum_PI'
 * '<S108>' : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Sum Fdbk/Disabled'
 * '<S109>' : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Tracking Mode/Disabled'
 * '<S110>' : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Tracking Mode Sum/Passthrough'
 * '<S111>' : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Tsamp - Integral/TsSignalSpecification'
 * '<S112>' : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/Tsamp - Ngain/Passthrough'
 * '<S113>' : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/postSat Signal/Forward_Path'
 * '<S114>' : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/preInt Signal/Internal PreInt'
 * '<S115>' : 'GVCU_HIL/Driver/Driver/Dec_controller/PI Controller/preSat Signal/Forward_Path'
 * '<S116>' : 'GVCU_HIL/Driver/Driver/LPF/Error LPF'
 * '<S117>' : 'GVCU_HIL/Environment/Air'
 * '<S118>' : 'GVCU_HIL/Environment/Friction'
 * '<S119>' : 'GVCU_HIL/Environment/Ground'
 * '<S120>' : 'GVCU_HIL/Environment/Wind'
 * '<S121>' : 'GVCU_HIL/GVCU - HiL/BMS'
 * '<S122>' : 'GVCU_HIL/GVCU - HiL/Commented messages'
 * '<S123>' : 'GVCU_HIL/GVCU - HiL/Compare To Constant'
 * '<S124>' : 'GVCU_HIL/GVCU - HiL/Message Output1'
 * '<S125>' : 'GVCU_HIL/GVCU - HiL/Message Output10'
 * '<S126>' : 'GVCU_HIL/GVCU - HiL/Message Output11'
 * '<S127>' : 'GVCU_HIL/GVCU - HiL/Message Output17'
 * '<S128>' : 'GVCU_HIL/GVCU - HiL/Message Output18'
 * '<S129>' : 'GVCU_HIL/GVCU - HiL/Message Output2'
 * '<S130>' : 'GVCU_HIL/GVCU - HiL/Message Output21'
 * '<S131>' : 'GVCU_HIL/GVCU - HiL/Message Output3'
 * '<S132>' : 'GVCU_HIL/GVCU - HiL/Message Output7'
 * '<S133>' : 'GVCU_HIL/GVCU - HiL/Message Output8'
 * '<S134>' : 'GVCU_HIL/GVCU - HiL/Signal Input'
 * '<S135>' : 'GVCU_HIL/GVCU - HiL/Signal Input1'
 * '<S136>' : 'GVCU_HIL/GVCU - HiL/Signal Input2'
 * '<S137>' : 'GVCU_HIL/GVCU - HiL/Signal Output1'
 * '<S138>' : 'GVCU_HIL/GVCU - HiL/Signal Output10'
 * '<S139>' : 'GVCU_HIL/GVCU - HiL/Signal Output11'
 * '<S140>' : 'GVCU_HIL/GVCU - HiL/Signal Output12'
 * '<S141>' : 'GVCU_HIL/GVCU - HiL/Signal Output13'
 * '<S142>' : 'GVCU_HIL/GVCU - HiL/Signal Output15'
 * '<S143>' : 'GVCU_HIL/GVCU - HiL/Signal Output18'
 * '<S144>' : 'GVCU_HIL/GVCU - HiL/Signal Output2'
 * '<S145>' : 'GVCU_HIL/GVCU - HiL/Signal Output20'
 * '<S146>' : 'GVCU_HIL/GVCU - HiL/Signal Output23'
 * '<S147>' : 'GVCU_HIL/GVCU - HiL/Signal Output24'
 * '<S148>' : 'GVCU_HIL/GVCU - HiL/Signal Output25'
 * '<S149>' : 'GVCU_HIL/GVCU - HiL/Signal Output26'
 * '<S150>' : 'GVCU_HIL/GVCU - HiL/Signal Output27'
 * '<S151>' : 'GVCU_HIL/GVCU - HiL/Signal Output28'
 * '<S152>' : 'GVCU_HIL/GVCU - HiL/Signal Output3'
 * '<S153>' : 'GVCU_HIL/GVCU - HiL/Signal Output4'
 * '<S154>' : 'GVCU_HIL/GVCU - HiL/Signal Output5'
 * '<S155>' : 'GVCU_HIL/GVCU - HiL/Signal Output6'
 * '<S156>' : 'GVCU_HIL/GVCU - HiL/Signal Output7'
 * '<S157>' : 'GVCU_HIL/GVCU - HiL/Signal Output8'
 * '<S158>' : 'GVCU_HIL/GVCU - HiL/Signal Output9'
 * '<S159>' : 'GVCU_HIL/GVCU - HiL/System Variable Output1'
 * '<S160>' : 'GVCU_HIL/GVCU - HiL/System Variable Output2'
 * '<S161>' : 'GVCU_HIL/Inverter/INV'
 * '<S162>' : 'GVCU_HIL/Inverter/Message Output'
 * '<S163>' : 'GVCU_HIL/Inverter/Message Output1'
 * '<S164>' : 'GVCU_HIL/Inverter/Message Output2'
 * '<S165>' : 'GVCU_HIL/Inverter/Message Output3'
 * '<S166>' : 'GVCU_HIL/Inverter/Message Output4'
 * '<S167>' : 'GVCU_HIL/Inverter/Message Output5'
 * '<S168>' : 'GVCU_HIL/Inverter/Message Output6'
 * '<S169>' : 'GVCU_HIL/Inverter/Message Output7'
 * '<S170>' : 'GVCU_HIL/Inverter/Signal Input2'
 * '<S171>' : 'GVCU_HIL/Inverter/Signal Input3'
 * '<S172>' : 'GVCU_HIL/Inverter/Signal Input4'
 * '<S173>' : 'GVCU_HIL/Inverter/Signal Input5'
 * '<S174>' : 'GVCU_HIL/Model_observation/System Variable Output'
 * '<S175>' : 'GVCU_HIL/Model_observation/System Variable Output11'
 * '<S176>' : 'GVCU_HIL/Model_observation/System Variable Output12'
 * '<S177>' : 'GVCU_HIL/Model_observation/System Variable Output13'
 * '<S178>' : 'GVCU_HIL/Model_observation/System Variable Output14'
 * '<S179>' : 'GVCU_HIL/Model_observation/System Variable Output16'
 * '<S180>' : 'GVCU_HIL/Model_observation/System Variable Output17'
 * '<S181>' : 'GVCU_HIL/Model_observation/System Variable Output18'
 * '<S182>' : 'GVCU_HIL/Model_observation/System Variable Output19'
 * '<S183>' : 'GVCU_HIL/Model_observation/System Variable Output20'
 * '<S184>' : 'GVCU_HIL/Model_observation/System Variable Output21'
 * '<S185>' : 'GVCU_HIL/Model_observation/System Variable Output22'
 * '<S186>' : 'GVCU_HIL/Model_observation/System Variable Output23'
 * '<S187>' : 'GVCU_HIL/Model_observation/System Variable Output24'
 * '<S188>' : 'GVCU_HIL/Model_observation/System Variable Output25'
 * '<S189>' : 'GVCU_HIL/Model_observation/System Variable Output26'
 * '<S190>' : 'GVCU_HIL/Model_observation/System Variable Output27'
 * '<S191>' : 'GVCU_HIL/Model_observation/System Variable Output3'
 * '<S192>' : 'GVCU_HIL/Model_observation/System Variable Output4'
 * '<S193>' : 'GVCU_HIL/Model_observation/System Variable Output5'
 * '<S194>' : 'GVCU_HIL/Model_observation/System Variable Output6'
 * '<S195>' : 'GVCU_HIL/Model_observation/System Variable Output7'
 * '<S196>' : 'GVCU_HIL/Model_observation/System Variable Output8'
 * '<S197>' : 'GVCU_HIL/Powertrain (EV)/Compare To Constant'
 * '<S198>' : 'GVCU_HIL/Powertrain (EV)/EM'
 * '<S199>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted'
 * '<S200>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller'
 * '<S201>' : 'GVCU_HIL/Powertrain (EV)/Signal Input1'
 * '<S202>' : 'GVCU_HIL/Powertrain (EV)/Signal Input2'
 * '<S203>' : 'GVCU_HIL/Powertrain (EV)/Signal Input4'
 * '<S204>' : 'GVCU_HIL/Powertrain (EV)/EM/Datasheet Battery2'
 * '<S205>' : 'GVCU_HIL/Powertrain (EV)/EM/Mapped Motor'
 * '<S206>' : 'GVCU_HIL/Powertrain (EV)/EM/Datasheet Battery2/Datasheet Battery Internal'
 * '<S207>' : 'GVCU_HIL/Powertrain (EV)/EM/Datasheet Battery2/Info Bus'
 * '<S208>' : 'GVCU_HIL/Powertrain (EV)/EM/Datasheet Battery2/Output Passthrough'
 * '<S209>' : 'GVCU_HIL/Powertrain (EV)/EM/Datasheet Battery2/Datasheet Battery Internal/Datasheet Battery'
 * '<S210>' : 'GVCU_HIL/Powertrain (EV)/EM/Datasheet Battery2/Datasheet Battery Internal/Datasheet Battery/Charge Model'
 * '<S211>' : 'GVCU_HIL/Powertrain (EV)/EM/Datasheet Battery2/Datasheet Battery Internal/Datasheet Battery/State of Charge Capacity'
 * '<S212>' : 'GVCU_HIL/Powertrain (EV)/EM/Datasheet Battery2/Datasheet Battery Internal/Datasheet Battery/Voltage and Power Calculation'
 * '<S213>' : 'GVCU_HIL/Powertrain (EV)/EM/Datasheet Battery2/Datasheet Battery Internal/Datasheet Battery/Voltage and Power Calculation/Em'
 * '<S214>' : 'GVCU_HIL/Powertrain (EV)/EM/Datasheet Battery2/Datasheet Battery Internal/Datasheet Battery/Voltage and Power Calculation/R'
 * '<S215>' : 'GVCU_HIL/Powertrain (EV)/EM/Datasheet Battery2/Datasheet Battery Internal/Datasheet Battery/Voltage and Power Calculation/Em/SOC Only Em'
 * '<S216>' : 'GVCU_HIL/Powertrain (EV)/EM/Datasheet Battery2/Datasheet Battery Internal/Datasheet Battery/Voltage and Power Calculation/R/SOC and Temp R'
 * '<S217>' : 'GVCU_HIL/Powertrain (EV)/EM/Datasheet Battery2/Info Bus/Power Accounting Bus Creator'
 * '<S218>' : 'GVCU_HIL/Powertrain (EV)/EM/Datasheet Battery2/Info Bus/Power Accounting Bus Creator/PwrNotTrnsfrd Input'
 * '<S219>' : 'GVCU_HIL/Powertrain (EV)/EM/Datasheet Battery2/Info Bus/Power Accounting Bus Creator/PwrStored Input'
 * '<S220>' : 'GVCU_HIL/Powertrain (EV)/EM/Datasheet Battery2/Info Bus/Power Accounting Bus Creator/PwrTrnsfrd Input'
 * '<S221>' : 'GVCU_HIL/Powertrain (EV)/EM/Mapped Motor/Electrical Current'
 * '<S222>' : 'GVCU_HIL/Powertrain (EV)/EM/Mapped Motor/Motor Units'
 * '<S223>' : 'GVCU_HIL/Powertrain (EV)/EM/Mapped Motor/No Inertia'
 * '<S224>' : 'GVCU_HIL/Powertrain (EV)/EM/Mapped Motor/Tabular Power Loss Data'
 * '<S225>' : 'GVCU_HIL/Powertrain (EV)/EM/Mapped Motor/Tabulated Torque-speed Envelope'
 * '<S226>' : 'GVCU_HIL/Powertrain (EV)/EM/Mapped Motor/Motor Units/Power Accounting Bus Creator'
 * '<S227>' : 'GVCU_HIL/Powertrain (EV)/EM/Mapped Motor/Motor Units/Power Accounting Bus Creator/PwrNotTrnsfrd Input'
 * '<S228>' : 'GVCU_HIL/Powertrain (EV)/EM/Mapped Motor/Motor Units/Power Accounting Bus Creator/PwrStored Input'
 * '<S229>' : 'GVCU_HIL/Powertrain (EV)/EM/Mapped Motor/Motor Units/Power Accounting Bus Creator/PwrTrnsfrd Input'
 * '<S230>' : 'GVCU_HIL/Powertrain (EV)/EM/Mapped Motor/Tabulated Torque-speed Envelope/Saturation Dynamic'
 * '<S231>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL'
 * '<S232>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL_Clutch'
 * '<S233>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR'
 * '<S234>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR_Clutch'
 * '<S235>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/Rotational Inertia'
 * '<S236>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/Split Torsional Compliance'
 * '<S237>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL/Torsional Compliance Linear'
 * '<S238>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL/Torsional Compliance Linear/Cont LPF IC Dyn'
 * '<S239>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL/Torsional Compliance Linear/Power'
 * '<S240>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL/Torsional Compliance Linear/Power/Damping Power'
 * '<S241>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL/Torsional Compliance Linear/Power/Power Accounting Bus Creator'
 * '<S242>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL/Torsional Compliance Linear/Power/Power Accounting Bus Creator/PwrNotTrnsfrd Input'
 * '<S243>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL/Torsional Compliance Linear/Power/Power Accounting Bus Creator/PwrStored Input'
 * '<S244>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL/Torsional Compliance Linear/Power/Power Accounting Bus Creator/PwrTrnsfrd Input'
 * '<S245>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL_Clutch/Dry Clutch'
 * '<S246>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL_Clutch/Dry Clutch/Bus Creation'
 * '<S247>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL_Clutch/Dry Clutch/F2T'
 * '<S248>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL_Clutch/Dry Clutch/Friction Mode'
 * '<S249>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL_Clutch/Dry Clutch/IC tunable'
 * '<S250>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL_Clutch/Dry Clutch/LPF'
 * '<S251>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL_Clutch/Dry Clutch/Locked'
 * '<S252>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL_Clutch/Dry Clutch/Unlocked'
 * '<S253>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL_Clutch/Dry Clutch/input IC'
 * '<S254>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL_Clutch/Dry Clutch/output IC'
 * '<S255>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL_Clutch/Dry Clutch/Bus Creation/Efficiency Calculation'
 * '<S256>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL_Clutch/Dry Clutch/Bus Creation/Power Accounting Bus Creator'
 * '<S257>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL_Clutch/Dry Clutch/Bus Creation/Efficiency Calculation/div0protect - abs poly'
 * '<S258>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL_Clutch/Dry Clutch/Bus Creation/Efficiency Calculation/div0protect - abs poly/Compare To Constant'
 * '<S259>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL_Clutch/Dry Clutch/Bus Creation/Efficiency Calculation/div0protect - abs poly/Compare To Constant1'
 * '<S260>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL_Clutch/Dry Clutch/Bus Creation/Power Accounting Bus Creator/PwrNotTrnsfrd Input'
 * '<S261>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL_Clutch/Dry Clutch/Bus Creation/Power Accounting Bus Creator/PwrStored Input'
 * '<S262>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL_Clutch/Dry Clutch/Bus Creation/Power Accounting Bus Creator/PwrTrnsfrd Input'
 * '<S263>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL_Clutch/Dry Clutch/F2T/Friction Model'
 * '<S264>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL_Clutch/Dry Clutch/LPF/LPF'
 * '<S265>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL_Clutch/Dry Clutch/LPF/LPF/Error LPF'
 * '<S266>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL_Clutch/Dry Clutch/Unlocked/div0protect - abs poly1'
 * '<S267>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL_Clutch/Dry Clutch/Unlocked/div0protect - abs poly1/Compare To Constant'
 * '<S268>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FL_Clutch/Dry Clutch/Unlocked/div0protect - abs poly1/Compare To Constant1'
 * '<S269>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR/Torsional Compliance Linear'
 * '<S270>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR/Torsional Compliance Linear/Cont LPF IC Dyn'
 * '<S271>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR/Torsional Compliance Linear/Power'
 * '<S272>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR/Torsional Compliance Linear/Power/Damping Power'
 * '<S273>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR/Torsional Compliance Linear/Power/Power Accounting Bus Creator'
 * '<S274>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR/Torsional Compliance Linear/Power/Power Accounting Bus Creator/PwrNotTrnsfrd Input'
 * '<S275>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR/Torsional Compliance Linear/Power/Power Accounting Bus Creator/PwrStored Input'
 * '<S276>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR/Torsional Compliance Linear/Power/Power Accounting Bus Creator/PwrTrnsfrd Input'
 * '<S277>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR_Clutch/Dry Clutch'
 * '<S278>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR_Clutch/Dry Clutch/Bus Creation'
 * '<S279>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR_Clutch/Dry Clutch/F2T'
 * '<S280>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR_Clutch/Dry Clutch/Friction Mode'
 * '<S281>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR_Clutch/Dry Clutch/IC tunable'
 * '<S282>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR_Clutch/Dry Clutch/LPF'
 * '<S283>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR_Clutch/Dry Clutch/Locked'
 * '<S284>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR_Clutch/Dry Clutch/Unlocked'
 * '<S285>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR_Clutch/Dry Clutch/input IC'
 * '<S286>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR_Clutch/Dry Clutch/output IC'
 * '<S287>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR_Clutch/Dry Clutch/Bus Creation/Efficiency Calculation'
 * '<S288>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR_Clutch/Dry Clutch/Bus Creation/Power Accounting Bus Creator'
 * '<S289>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR_Clutch/Dry Clutch/Bus Creation/Efficiency Calculation/div0protect - abs poly'
 * '<S290>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR_Clutch/Dry Clutch/Bus Creation/Efficiency Calculation/div0protect - abs poly/Compare To Constant'
 * '<S291>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR_Clutch/Dry Clutch/Bus Creation/Efficiency Calculation/div0protect - abs poly/Compare To Constant1'
 * '<S292>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR_Clutch/Dry Clutch/Bus Creation/Power Accounting Bus Creator/PwrNotTrnsfrd Input'
 * '<S293>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR_Clutch/Dry Clutch/Bus Creation/Power Accounting Bus Creator/PwrStored Input'
 * '<S294>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR_Clutch/Dry Clutch/Bus Creation/Power Accounting Bus Creator/PwrTrnsfrd Input'
 * '<S295>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR_Clutch/Dry Clutch/F2T/Friction Model'
 * '<S296>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR_Clutch/Dry Clutch/LPF/LPF'
 * '<S297>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR_Clutch/Dry Clutch/LPF/LPF/Error LPF'
 * '<S298>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR_Clutch/Dry Clutch/Unlocked/div0protect - abs poly1'
 * '<S299>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR_Clutch/Dry Clutch/Unlocked/div0protect - abs poly1/Compare To Constant'
 * '<S300>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/FR_Clutch/Dry Clutch/Unlocked/div0protect - abs poly1/Compare To Constant1'
 * '<S301>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/Rotational Inertia/Rotational Inertia'
 * '<S302>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/Rotational Inertia/Rotational Inertia/Rotational Inertia External Input'
 * '<S303>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/Rotational Inertia/Rotational Inertia/Rotational Inertia External Input/Power'
 * '<S304>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/Rotational Inertia/Rotational Inertia/Rotational Inertia External Input/div0protect - abs poly'
 * '<S305>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/Rotational Inertia/Rotational Inertia/Rotational Inertia External Input/Power/Damping Power'
 * '<S306>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/Rotational Inertia/Rotational Inertia/Rotational Inertia External Input/Power/Kinetic Power'
 * '<S307>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/Rotational Inertia/Rotational Inertia/Rotational Inertia External Input/Power/Power Accounting Bus Creator'
 * '<S308>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/Rotational Inertia/Rotational Inertia/Rotational Inertia External Input/Power/Power Accounting Bus Creator/PwrNotTrnsfrd Input'
 * '<S309>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/Rotational Inertia/Rotational Inertia/Rotational Inertia External Input/Power/Power Accounting Bus Creator/PwrStored Input'
 * '<S310>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/Rotational Inertia/Rotational Inertia/Rotational Inertia External Input/Power/Power Accounting Bus Creator/PwrTrnsfrd Input'
 * '<S311>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/Rotational Inertia/Rotational Inertia/Rotational Inertia External Input/div0protect - abs poly/Compare To Constant'
 * '<S312>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/Rotational Inertia/Rotational Inertia/Rotational Inertia External Input/div0protect - abs poly/Compare To Constant1'
 * '<S313>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/Split Torsional Compliance/Torsional Compliance Coupler'
 * '<S314>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/Split Torsional Compliance/Torsional Compliance Coupler/Cont LPF IC Dyn'
 * '<S315>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/Split Torsional Compliance/Torsional Compliance Coupler/Power'
 * '<S316>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/Split Torsional Compliance/Torsional Compliance Coupler/Power/Damping Power'
 * '<S317>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/Split Torsional Compliance/Torsional Compliance Coupler/Power/Power Accounting Bus Creator'
 * '<S318>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/Split Torsional Compliance/Torsional Compliance Coupler/Power/Power Accounting Bus Creator/PwrNotTrnsfrd Input'
 * '<S319>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/Split Torsional Compliance/Torsional Compliance Coupler/Power/Power Accounting Bus Creator/PwrStored Input'
 * '<S320>' : 'GVCU_HIL/Powertrain (EV)/FWD_ELEC_Powertrain_sorted/Split Torsional Compliance/Torsional Compliance Coupler/Power/Power Accounting Bus Creator/PwrTrnsfrd Input'
 * '<S321>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/MATLAB Function'
 * '<S322>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1'
 * '<S323>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/Saturation Dynamic'
 * '<S324>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Anti-windup'
 * '<S325>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/D Gain'
 * '<S326>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/External Derivative'
 * '<S327>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Filter'
 * '<S328>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Filter ICs'
 * '<S329>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/I Gain'
 * '<S330>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Ideal P Gain'
 * '<S331>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Ideal P Gain Fdbk'
 * '<S332>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Integrator'
 * '<S333>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Integrator ICs'
 * '<S334>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/N Copy'
 * '<S335>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/N Gain'
 * '<S336>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/P Copy'
 * '<S337>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Parallel P Gain'
 * '<S338>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Reset Signal'
 * '<S339>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Saturation'
 * '<S340>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Saturation Fdbk'
 * '<S341>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Sum'
 * '<S342>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Sum Fdbk'
 * '<S343>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Tracking Mode'
 * '<S344>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Tracking Mode Sum'
 * '<S345>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Tsamp - Integral'
 * '<S346>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Tsamp - Ngain'
 * '<S347>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/postSat Signal'
 * '<S348>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/preInt Signal'
 * '<S349>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/preSat Signal'
 * '<S350>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Anti-windup/Back Calculation'
 * '<S351>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/D Gain/Disabled'
 * '<S352>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/External Derivative/Disabled'
 * '<S353>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Filter/Disabled'
 * '<S354>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Filter ICs/Disabled'
 * '<S355>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/I Gain/Internal Parameters'
 * '<S356>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Ideal P Gain/Passthrough'
 * '<S357>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Ideal P Gain Fdbk/Passthrough'
 * '<S358>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Integrator/Discrete'
 * '<S359>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Integrator ICs/Internal IC'
 * '<S360>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/N Copy/Disabled wSignal Specification'
 * '<S361>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/N Gain/Disabled'
 * '<S362>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/P Copy/Disabled'
 * '<S363>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Parallel P Gain/Internal Parameters'
 * '<S364>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Reset Signal/External Reset'
 * '<S365>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Saturation/Enabled'
 * '<S366>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Saturation Fdbk/Enabled'
 * '<S367>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Sum/Sum_PI'
 * '<S368>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Sum Fdbk/Enabled'
 * '<S369>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Tracking Mode/Disabled'
 * '<S370>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Tracking Mode Sum/Passthrough'
 * '<S371>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Tsamp - Integral/TsSignalSpecification'
 * '<S372>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/Tsamp - Ngain/Passthrough'
 * '<S373>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/postSat Signal/Feedback_Path'
 * '<S374>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/preInt Signal/Internal PreInt'
 * '<S375>' : 'GVCU_HIL/Powertrain (EV)/PID Speed Controller/PID Controller1/preSat Signal/Feedback_Path'
 * '<S376>' : 'GVCU_HIL/Vehicle/Aerodynamics'
 * '<S377>' : 'GVCU_HIL/Vehicle/Subsystem'
 * '<S378>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal'
 * '<S379>' : 'GVCU_HIL/Vehicle/Wheels1'
 * '<S380>' : 'GVCU_HIL/Vehicle/to grade'
 * '<S381>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF'
 * '<S382>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation'
 * '<S383>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Inertial Axes'
 * '<S384>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Vehicle'
 * '<S385>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/WindDim'
 * '<S386>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Body Frame'
 * '<S387>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Forces'
 * '<S388>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Frame Routing'
 * '<S389>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Inertial Frame'
 * '<S390>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Moments'
 * '<S391>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Power'
 * '<S392>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Body Frame/Longitudinal 1DOF'
 * '<S393>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Forces/Forces 1DOF'
 * '<S394>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Frame Routing/Longitudinal 1DOF'
 * '<S395>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Frame Routing/Longitudinal 1DOF/Hard Point Coordinate Transform Front'
 * '<S396>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Frame Routing/Longitudinal 1DOF/Hard Point Coordinate Transform Rear'
 * '<S397>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Frame Routing/Longitudinal 1DOF/Hard Point Coordinate Transform Front/Rotation Angles to Direction Cosine Matrix'
 * '<S398>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Frame Routing/Longitudinal 1DOF/Hard Point Coordinate Transform Front/transform to Inertial axes'
 * '<S399>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Frame Routing/Longitudinal 1DOF/Hard Point Coordinate Transform Front/transform to Inertial axes1'
 * '<S400>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Frame Routing/Longitudinal 1DOF/Hard Point Coordinate Transform Front/wxR'
 * '<S401>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Frame Routing/Longitudinal 1DOF/Hard Point Coordinate Transform Front/Rotation Angles to Direction Cosine Matrix/Create 3x3 Matrix'
 * '<S402>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Frame Routing/Longitudinal 1DOF/Hard Point Coordinate Transform Front/wxR/Subsystem'
 * '<S403>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Frame Routing/Longitudinal 1DOF/Hard Point Coordinate Transform Front/wxR/Subsystem1'
 * '<S404>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Frame Routing/Longitudinal 1DOF/Hard Point Coordinate Transform Rear/Rotation Angles to Direction Cosine Matrix'
 * '<S405>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Frame Routing/Longitudinal 1DOF/Hard Point Coordinate Transform Rear/transform to Inertial axes'
 * '<S406>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Frame Routing/Longitudinal 1DOF/Hard Point Coordinate Transform Rear/transform to Inertial axes1'
 * '<S407>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Frame Routing/Longitudinal 1DOF/Hard Point Coordinate Transform Rear/wxR'
 * '<S408>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Frame Routing/Longitudinal 1DOF/Hard Point Coordinate Transform Rear/Rotation Angles to Direction Cosine Matrix/Create 3x3 Matrix'
 * '<S409>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Frame Routing/Longitudinal 1DOF/Hard Point Coordinate Transform Rear/wxR/Subsystem'
 * '<S410>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Frame Routing/Longitudinal 1DOF/Hard Point Coordinate Transform Rear/wxR/Subsystem1'
 * '<S411>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Inertial Frame/Inertial Axes'
 * '<S412>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Inertial Frame/Inertial Axes/Rotation Angles to Direction Cosine Matrix'
 * '<S413>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Inertial Frame/Inertial Axes/Rotation Angles to Direction Cosine Matrix/Create 3x3 Matrix'
 * '<S414>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Power/Longitudinal 1DOF'
 * '<S415>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Power/Longitudinal 1DOF/Power Accounting Bus Creator'
 * '<S416>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Power/Longitudinal 1DOF/Power Accounting Bus Creator/PwrNotTrnsfrd Input'
 * '<S417>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Power/Longitudinal 1DOF/Power Accounting Bus Creator/PwrStored Input'
 * '<S418>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Bus Creation/Power/Longitudinal 1DOF/Power Accounting Bus Creator/PwrTrnsfrd Input'
 * '<S419>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Inertial Axes/Rotation Angles to Direction Cosine Matrix'
 * '<S420>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Inertial Axes/Rotation Angles to Direction Cosine Matrix/Create 3x3 Matrix'
 * '<S421>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Vehicle/Drag Force'
 * '<S422>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/Vehicle/Drag Force/Side Slip'
 * '<S423>' : 'GVCU_HIL/Vehicle/Vehicle Body 1DOF Longitudinal/Vehicle Body 1 DOF/WindDim/WindX'
 * '<S424>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake'
 * '<S425>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1'
 * '<S426>' : 'GVCU_HIL/Vehicle/Wheels1/Subsystem'
 * '<S427>' : 'GVCU_HIL/Vehicle/Wheels1/System Variable Output'
 * '<S428>' : 'GVCU_HIL/Vehicle/Wheels1/System Variable Output1'
 * '<S429>' : 'GVCU_HIL/Vehicle/Wheels1/System Variable Output2'
 * '<S430>' : 'GVCU_HIL/Vehicle/Wheels1/whel to axel transform3'
 * '<S431>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Brush Contact'
 * '<S432>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Bus Routing'
 * '<S433>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Longitudinal Basic Magic Tire'
 * '<S434>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Longitudinal Parameters'
 * '<S435>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Rolling Parameters'
 * '<S436>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Vertical DOF'
 * '<S437>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Wheel Module'
 * '<S438>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Brush Contact/Brush Contact'
 * '<S439>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Brush Contact/Brush Contact/Blending'
 * '<S440>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Brush Contact/Brush Contact/Bristle Deflection'
 * '<S441>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Brush Contact/Brush Contact/Blending/Low Speed Scaling'
 * '<S442>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Brush Contact/Brush Contact/Blending/Low Speed Scaling/MATLAB Function'
 * '<S443>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Brush Contact/Brush Contact/Bristle Deflection/Bristle Deflection'
 * '<S444>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Brush Contact/Brush Contact/Bristle Deflection/MATLAB Function'
 * '<S445>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Brush Contact/Brush Contact/Bristle Deflection/MF constant coeff'
 * '<S446>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Brush Contact/Brush Contact/Bristle Deflection/Saturation Dynamic'
 * '<S447>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Brush Contact/Brush Contact/Bristle Deflection/Bristle Deflection/Compare To Zero'
 * '<S448>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Brush Contact/Brush Contact/Bristle Deflection/Bristle Deflection/Compare To Zero1'
 * '<S449>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Brush Contact/Brush Contact/Bristle Deflection/Bristle Deflection/Saturation Dynamic'
 * '<S450>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Brush Contact/Brush Contact/Bristle Deflection/MATLAB Function/MATLAB Function'
 * '<S451>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Brush Contact/Brush Contact/Bristle Deflection/MF constant coeff/MF constant coeff'
 * '<S452>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Bus Routing/Power'
 * '<S453>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Bus Routing/Power/Power Accounting Bus Creator'
 * '<S454>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Bus Routing/Power/Power Accounting Bus Creator/PwrNotTrnsfrd Input'
 * '<S455>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Bus Routing/Power/Power Accounting Bus Creator/PwrStored Input'
 * '<S456>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Bus Routing/Power/Power Accounting Bus Creator/PwrTrnsfrd Input'
 * '<S457>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Longitudinal Basic Magic Tire/Simple Magic Tire'
 * '<S458>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Longitudinal Parameters/Magic Formula Peak Value'
 * '<S459>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Rolling Parameters/None'
 * '<S460>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Vertical DOF/None'
 * '<S461>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Wheel Module/Brakes'
 * '<S462>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Wheel Module/Clutch'
 * '<S463>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Wheel Module/Friction Model'
 * '<S464>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Wheel Module/relaxation'
 * '<S465>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Wheel Module/Brakes/Disk Brake'
 * '<S466>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Wheel Module/Brakes/Disk Brake/Disk Brake'
 * '<S467>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Wheel Module/Clutch/Clutch'
 * '<S468>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Wheel Module/Clutch/Clutch/Locked'
 * '<S469>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Wheel Module/Clutch/Clutch/Slipping'
 * '<S470>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Wheel Module/Clutch/Clutch/detectLockup'
 * '<S471>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Wheel Module/Clutch/Clutch/detectSlip'
 * '<S472>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Wheel Module/Clutch/Clutch/detectLockup/Friction Mode Logic'
 * '<S473>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Wheel Module/Clutch/Clutch/detectLockup/Friction Mode Logic/Break Apart Detection'
 * '<S474>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Wheel Module/Clutch/Clutch/detectLockup/Friction Mode Logic/Lockup Detection'
 * '<S475>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Wheel Module/Clutch/Clutch/detectLockup/Friction Mode Logic/Lockup FSM'
 * '<S476>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Wheel Module/Clutch/Clutch/detectLockup/Friction Mode Logic/Requisite Friction'
 * '<S477>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Wheel Module/Clutch/Clutch/detectLockup/Friction Mode Logic/Lockup Detection/Friction Calc'
 * '<S478>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Wheel Module/Clutch/Clutch/detectLockup/Friction Mode Logic/Lockup Detection/Required Friction for Lockup'
 * '<S479>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Wheel Module/Clutch/Clutch/detectLockup/Friction Mode Logic/Lockup Detection/Required Friction for Lockup/Compare To Zero'
 * '<S480>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Wheel Module/Clutch/Clutch/detectSlip/Break Apart Detection'
 * '<S481>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Wheel Module/relaxation/Cont LPF Dyn'
 * '<S482>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Wheel Module/relaxation/Low Speed Scaling'
 * '<S483>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Wheel Module/relaxation/div0protect - abs poly'
 * '<S484>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Wheel Module/relaxation/Low Speed Scaling/MATLAB Function'
 * '<S485>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Wheel Module/relaxation/div0protect - abs poly/Compare To Constant'
 * '<S486>' : 'GVCU_HIL/Vehicle/Wheels1/Front Longitudinal Wheel - Disc Brake/Wheel Module/relaxation/div0protect - abs poly/Compare To Constant1'
 * '<S487>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Brush Contact'
 * '<S488>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Bus Routing'
 * '<S489>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Longitudinal Basic Magic Tire'
 * '<S490>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Longitudinal Parameters'
 * '<S491>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Rolling Parameters'
 * '<S492>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Vertical DOF'
 * '<S493>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Wheel Module'
 * '<S494>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Brush Contact/Brush Contact'
 * '<S495>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Brush Contact/Brush Contact/Blending'
 * '<S496>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Brush Contact/Brush Contact/Bristle Deflection'
 * '<S497>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Brush Contact/Brush Contact/Blending/Low Speed Scaling'
 * '<S498>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Brush Contact/Brush Contact/Blending/Low Speed Scaling/MATLAB Function'
 * '<S499>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Brush Contact/Brush Contact/Bristle Deflection/Bristle Deflection'
 * '<S500>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Brush Contact/Brush Contact/Bristle Deflection/MATLAB Function'
 * '<S501>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Brush Contact/Brush Contact/Bristle Deflection/MF constant coeff'
 * '<S502>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Brush Contact/Brush Contact/Bristle Deflection/Saturation Dynamic'
 * '<S503>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Brush Contact/Brush Contact/Bristle Deflection/Bristle Deflection/Compare To Zero'
 * '<S504>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Brush Contact/Brush Contact/Bristle Deflection/Bristle Deflection/Compare To Zero1'
 * '<S505>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Brush Contact/Brush Contact/Bristle Deflection/Bristle Deflection/Saturation Dynamic'
 * '<S506>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Brush Contact/Brush Contact/Bristle Deflection/MATLAB Function/MATLAB Function'
 * '<S507>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Brush Contact/Brush Contact/Bristle Deflection/MF constant coeff/MF constant coeff'
 * '<S508>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Bus Routing/Power'
 * '<S509>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Bus Routing/Power/Power Accounting Bus Creator'
 * '<S510>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Bus Routing/Power/Power Accounting Bus Creator/PwrNotTrnsfrd Input'
 * '<S511>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Bus Routing/Power/Power Accounting Bus Creator/PwrStored Input'
 * '<S512>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Bus Routing/Power/Power Accounting Bus Creator/PwrTrnsfrd Input'
 * '<S513>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Longitudinal Basic Magic Tire/Simple Magic Tire'
 * '<S514>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Longitudinal Parameters/Magic Formula Peak Value'
 * '<S515>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Rolling Parameters/None'
 * '<S516>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Vertical DOF/None'
 * '<S517>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Wheel Module/Brakes'
 * '<S518>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Wheel Module/Clutch'
 * '<S519>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Wheel Module/Friction Model'
 * '<S520>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Wheel Module/relaxation'
 * '<S521>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Wheel Module/Brakes/Disk Brake'
 * '<S522>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Wheel Module/Brakes/Disk Brake/Disk Brake'
 * '<S523>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Wheel Module/Clutch/Clutch'
 * '<S524>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Wheel Module/Clutch/Clutch/Locked'
 * '<S525>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Wheel Module/Clutch/Clutch/Slipping'
 * '<S526>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Wheel Module/Clutch/Clutch/detectLockup'
 * '<S527>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Wheel Module/Clutch/Clutch/detectSlip'
 * '<S528>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Wheel Module/Clutch/Clutch/detectLockup/Friction Mode Logic'
 * '<S529>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Wheel Module/Clutch/Clutch/detectLockup/Friction Mode Logic/Break Apart Detection'
 * '<S530>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Wheel Module/Clutch/Clutch/detectLockup/Friction Mode Logic/Lockup Detection'
 * '<S531>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Wheel Module/Clutch/Clutch/detectLockup/Friction Mode Logic/Lockup FSM'
 * '<S532>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Wheel Module/Clutch/Clutch/detectLockup/Friction Mode Logic/Requisite Friction'
 * '<S533>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Wheel Module/Clutch/Clutch/detectLockup/Friction Mode Logic/Lockup Detection/Friction Calc'
 * '<S534>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Wheel Module/Clutch/Clutch/detectLockup/Friction Mode Logic/Lockup Detection/Required Friction for Lockup'
 * '<S535>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Wheel Module/Clutch/Clutch/detectLockup/Friction Mode Logic/Lockup Detection/Required Friction for Lockup/Compare To Zero'
 * '<S536>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Wheel Module/Clutch/Clutch/detectSlip/Break Apart Detection'
 * '<S537>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Wheel Module/relaxation/Cont LPF Dyn'
 * '<S538>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Wheel Module/relaxation/Low Speed Scaling'
 * '<S539>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Wheel Module/relaxation/div0protect - abs poly'
 * '<S540>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Wheel Module/relaxation/Low Speed Scaling/MATLAB Function'
 * '<S541>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Wheel Module/relaxation/div0protect - abs poly/Compare To Constant'
 * '<S542>' : 'GVCU_HIL/Vehicle/Wheels1/Rear Longitudinal Wheel - Disc Brake1/Wheel Module/relaxation/div0protect - abs poly/Compare To Constant1'
 * '<S543>' : 'GVCU_HIL/Vehicle/to grade/Radians to Degrees '
 * '<S544>' : 'GVCU_HIL/Wheel_rates/MATLAB Function2'
 * '<S545>' : 'GVCU_HIL/Wheel_rates/System Variable Output'
