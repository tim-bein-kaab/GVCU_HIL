...
PmfMessageId Simscape_DiL_Gemera_24b_a41ef8b8_1_compOutputsKin(const
  ...
  double *discreteState, double *output, NeuDiagnosticManager *neDiagMgr)
{
  ...
  bb[0] = sm_core_compiler_computeProximityInfoPlaneTire(
    ...
    (xx + 11), (pm_math_Transform3 *)(xx + 55), xx[64], 1, (pm_math_Vector3 *)
    (xx + 261), (pm_math_Vector3 *)(xx + 264));
  xx[55] = - xx[43];
  ...
  bb[0] = sm_core_compiler_computeProximityInfoPlaneTire(
    Simscape_DiL_Gemera_24b_a41ef8b8_1_geometry_0(NULL), (pm_math_Transform3 *)
    (xx + 11), (pm_math_Transform3 *)(xx + 269), xx[42], 1, (pm_math_Vector3 *)
    (xx + 278), (pm_math_Vector3 *)(xx + 281));
  xx[269] = - xx[265];
  ...
  bb[0] = sm_core_compiler_computeProximityInfoPlaneTire(
    Simscape_DiL_Gemera_24b_a41ef8b8_1_geometry_0(NULL), (pm_math_Transform3 *)
    (xx + 11), (pm_math_Transform3 *)(xx + 102), xx[28], 1, (pm_math_Vector3 *)
    (xx + 67), (pm_math_Vector3 *)(xx + 70));
  xx[73] = - xx[94];
  ...
  bb[0] = sm_core_compiler_computeProximityInfoPlaneTire(
    Simscape_DiL_Gemera_24b_a41ef8b8_1_geometry_0(NULL), (pm_math_Transform3 *)
    (xx + 11), (pm_math_Transform3 *)(xx + 90), xx[70], 1, (pm_math_Vector3 *)
    (xx + 102), (pm_math_Vector3 *)(xx + 105));
  xx[11] = - xx[84];
